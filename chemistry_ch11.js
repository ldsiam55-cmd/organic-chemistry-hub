...
<nav>
  ...
  <div class="nav-group">
    ...
    <button class="btn b-sy" onclick="chShow('sy',this)"><span data-i18n="nav_sy">🔬 How Made</span><span class="bs" data-i18n="sub_sy">6 Compounds</span></button>
  </div>
...
<div id="exr"><div class="exmt"><div class="exi">🔬</div><div class="ext">Select FROM &amp; TO above</div></div></div>`;
  ...
  // ── SYNTHESIS ──
  panels['sy'] = `
<div class="ph" style="border-color:#fb923c;color:#fb923c"><div class="phi">🔬</div><div><div class="pht">How They're Made — Synthesis</div><div class="phb"><span class="badge">Alkane · Alkene · Alkyne</span><span class="badge">Alcohol · Aldehyde · Fatty Acid · Alkyl Halide</span><span class="badge">All prep methods</span></div><div class="phd">Click a compound card to see all preparation methods with reactions and explanations.</div></div></div>
<div class="spicks">
  <div class="spk ska" onclick="showSy('sa',this)"><span class="spki">🔥</span><span class="spkn">Alkane</span><span class="spkf">CₙH₂ₙ₊₂</span><span class="spkc">7 Methods</span></div>
  <div class="spk ske" onclick="showSy('se',this)"><span class="spki">🌿</span><span class="spkn">Alkene</span><span class="spkf">CₙH₂ₙ</span><span class="spkc">4 Methods</span></div>
  <div class="spk sky" onclick="showSy('sy',this)"><span class="spki">⚡</span><span class="spkn">Alkyne</span><span class="spkf">CₙH₂ₙ₋₂</span><span class="spkc">4 Methods</span></div>
  <div class="spk" style="border-color:var(--al);background:rgba(56,189,248,.06)" onclick="showSy('sal',this)"><span class="spki">🧪</span><span class="spkn" style="color:var(--al)">Alcohol</span><span class="spkf" style="color:var(--al)">–OH group</span><span class="spkc">4 Methods</span></div>
  <div class="spk" style="border-color:var(--ad);background:rgba(251,191,36,.06)" onclick="showSy('sad',this)"><span class="spki">✨</span><span class="spkn" style="color:var(--ad)">Aldehyde</span><span class="spkf" style="color:var(--ad)">–CHO group</span><span class="spkc">3 Methods</span></div>
  <div class="spk" style="border-color:var(--ac);background:rgba(244,114,182,.06)" onclick="showSy('sac',this)"><span class="spki">🧬</span><span class="spkn" style="color:var(--ac)">Fatty Acid</span><span class="spkf" style="color:var(--ac)">–COOH group</span><span class="spkc">3 Methods</span></div>
  <div class="spk" style="border-color:#a78bfa;background:rgba(167,139,250,.06)" onclick="showSy('shx',this)"><span class="spki">🔶</span><span class="spkn" style="color:#a78bfa">Alkyl Halide</span><span class="spkf" style="color:#a78bfa">R–X group</span><span class="spkc">4 Methods</span></div>
</div>

<!-- Alkane synth -->
<div id="sc-sa" class="scon">
<div class="schd" style="border-color:var(--ka);color:var(--ka)"><div class="scic">🔥</div><div><div class="sct">Alkane — CₙH₂ₙ₊₂</div><div class="scs">Saturated · sp³ · Paraffin ("little affinity to react") · C₁–C₄ gas · C₅–C₁₇ liquid · C₁₈+ solid</div></div><div class="scct">7 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 1</span><span class="smn">Decarboxylation — Descending (−1C)</span><span class="smtg">R-COONa + NaOH(CaO) → Alkane</span></div>
<div class="scene" style="color:var(--ka)"><div class="mol"><span class="moli">🧂</span><span class="molf">CH₃COONa</span><span class="moln">Sodium Ethanoate</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">NaOH(CaO)</span><span class="moln">Sodalime</span></div><div class="sarr"><span class="sat">Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ka)"><span class="moli gw">🔥</span><span class="molf mp">CH₄</span><span class="moln">Methane (−1C)</span></div><div class="sop">+</div><div class="mol"><span class="moli">🪨</span><span class="molf" style="color:#6ee7b7">Na₂CO₃</span><span class="moln">Sodium Carbonate</span></div></div>
<div class="seq"><span>R-COONa</span><span class="sl">+</span><span>NaOH(CaO)</span><span class="sc">Δ (sodalime)</span><span class="sa">⟶</span><span class="sp">R-H</span><span class="sl">+</span><span class="sp">Na₂CO₃</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Descending method — product has ONE LESS carbon</div><div class="sexd">–COO⁻ removed as CO₃²⁻. Sodium propanoate (3C) → ethane (2C). Key: sodalime = NaOH + CaO mixture. CaO keeps NaOH dry and active.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 2</span><span class="smn">Wurtz Reaction — Ascending (+2C)</span><span class="smtg">2 R-X + 2Na → R-R (dry ether)</span></div>
<div class="scene" style="color:var(--ka)"><div class="mol"><span class="moli">🧪</span><span class="molf">2 CH₃I</span><span class="moln">Methyl Iodide</span></div><div class="sop">+</div><div class="mol"><span class="moli">⚡</span><span class="molf">2Na</span><span class="moln">Sodium metal</span></div><div class="sarr"><span class="sat">dry ether</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ka)"><span class="moli gw">🔥</span><span class="molf mp">CH₃–CH₃</span><span class="moln">Ethane (+2C)</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">2NaI</span><span class="moln">Sodium Iodide</span></div></div>
<div class="seq"><span>R-X</span><span class="sl">+</span><span>2Na</span><span class="sl">+</span><span>X-R</span><span class="sc">dry ether</span><span class="sa">⟶</span><span class="sp">R-R</span><span class="sl">+</span><span class="sp">2NaX</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Ascending method — product has DOUBLE the carbons of alkyl halide</div><div class="sexd">Alkyl halide C-atoms × 2 = product alkane C-atoms. CH₃I (1C) → ethane (2C). C₂H₅I (2C) → butane (4C). Used to prepare HIGHER homologues of alkane.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 3</span><span class="smn">Clemmensen's Reduction</span><span class="smtg">Carbonyl + Zn.Hg + conc.HCl → Alkane</span></div>
<div class="scene" style="color:var(--ka)"><div class="mol"><span class="moli">✨</span><span class="molf">CH₃CHO</span><span class="moln">Ethanal</span></div><div class="sop">+</div><div class="mol"><span class="moli">⚗️</span><span class="molf">4[H]</span><span class="moln">Zn.Hg / conc.HCl</span></div><div class="sarr"><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ka)"><span class="moli gw">🔥</span><span class="molf mp">CH₃–CH₃</span><span class="moln">Ethane</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>R-CO-H/R</span><span class="sl">+</span><span>4[H]</span><span class="sc">Zn(Hg), conc.HCl</span><span class="sa">⟶</span><span class="sp">R-CH₂-H/R</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 C=O → –CH₂– (same number of carbons!)</div><div class="sexd">Zinc amalgam (Zn.Hg) + conc.HCl reduce the carbonyl group –C=O directly to methylene –CH₂–. Product alkane has SAME carbon count as starting aldehyde/ketone. Ethanal → ethane · Propanone → propane.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 4</span><span class="smn">Grignard Reagent + H₂O</span><span class="smtg">RMgX + H₂O → Alkane</span></div>
<div class="scene" style="color:var(--ka)"><div class="mol"><span class="moli">🧪</span><span class="molf">C₂H₅MgBr</span><span class="moln">Ethyl Mg Bromide</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf">H₂O</span><span class="moln">Water</span></div><div class="sarr"><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ka)"><span class="moli gw">🔥</span><span class="molf mp">C₂H₆</span><span class="moln">Ethane</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf" style="color:#6ee7b7">Mg(OH)Br</span><span class="moln">Byproduct</span></div></div>
<div class="seq"><span>RMgX</span><span class="sl">+</span><span>H-OH</span><span class="sa">⟶</span><span class="sp">R-H</span><span class="sl">+</span><span class="sp">Mg(OH)X</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Grignard hydrolysis</div><div class="sexd">Grignard reagent (RMgX) acts as source of R⁻ (nucleophile). Water provides H⁺. R-H alkane formed. Similarly C₆H₅MgCl + H₂O → benzene + Mg(OH)Cl.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 5</span><span class="smn">Alkene + H₂ (Hydrogenation)</span><span class="smtg">Ni, 180–200°C</span></div>
...
<div class="seq"><span>R-CH=CH-R</span><span class="sl">+</span><span>H₂</span><span class="sc">Ni, 180°C</span><span class="sa">⟶</span><span class="sp">R-CH₂-CH₂-R</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Addition of H₂ across C=C</div><div class="sexd">π bond of C=C breaks, H₂ adds across. Catalytic hydrogenation. Alkene → Alkane (same C count).</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 6</span><span class="smn">Alkyne + 2H₂ (Hydrogenation)</span><span class="smtg">Ni, 180–200°C</span></div>
...
<div class="seq"><span>R-C≡CH</span><span class="sl">+</span><span>2H₂</span><span class="sc">Ni, 180°C</span><span class="sa">⟶</span><span class="sp">R-CH₂-CH₃</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Needs 2 mol H₂ — triple bond has two π bonds</div><div class="sexd">Step 1: alkyne + H₂ → alkene (1st π broken). Step 2: alkene + H₂ → alkane (2nd π broken). Two hydrogenations needed.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ka)"><span class="smb2">Method 7</span><span class="smn">From Coal (Water Gas + Ni)</span><span class="smtg">C + H₂O at 1300°C → CO+H₂ → CH₄</span></div>
<div class="scene" style="color:var(--ka)"><div class="mol"><span class="moli">🪨</span><span class="molf">C(s) + H₂O</span><span class="moln">Coal + steam</span></div><div class="sarr"><span class="sat">1300°C</span><span class="sarri">⟶</span></div><div class="mol"><span class="moli">🫙</span><span class="molf">CO + H₂</span><span class="moln">Water gas</span></div><div class="sarr"><span class="sat">+2H₂, Ni</span><span class="sarri">⟶</span><span class="sab">300°C</span></div><div class="mol" style="color:var(--ka)"><span class="moli gw">🔥</span><span class="molf mp">CH₄</span><span class="moln">Methane</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Steam</span></div></div>
<div class="seq"><span>C+H₂O</span><span class="sc">1300°C</span><span class="sa">⟶</span><span class="sp">CO+H₂</span><span class="sc">+2H₂, Ni, 300°C</span><span class="sa">⟶</span><span class="sp">CH₄+H₂O</span></div>
<div class="sexpl" style="border-color:var(--ka);color:var(--ka)"><div class="sext">🧠 Industrial — only methane!</div><div class="sexd">Step 1: Steam over hot coal (1300°C) → water gas (CO + H₂). Step 2: Water gas + 2H₂ with Ni catalyst at 300°C → methane + steam. Only gives methane because starting material has 1C.</div></div></div>
</div>

<!-- Alkene synth -->
<div id="sc-se" class="scon">
<div class="schd" style="border-color:var(--ke);color:var(--ke)"><div class="scic">🌿</div><div><div class="sct">Alkene — CₙH₂ₙ</div><div class="scs">C=C double bond · C₂–C₄ gas · C₅–C₁₅ liquid · Used in polymer/plastic industry</div></div><div class="scct">4 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--ke)"><span class="smb2">Method 1</span><span class="smn">Catalytic Dehydration of Alcohol</span><span class="smtg">Al₂O₃ or ThO₂, 350–400°C</span></div>
<div class="scene" style="color:var(--ke)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂OH</span><span class="moln">Ethanol</span></div><div class="sarr"><span class="sat">Al₂O₃</span><span class="sarri">⟶</span><span class="sab">350°C</span></div><div class="mol" style="color:var(--ke)"><span class="moli gw">🌿</span><span class="molf mp">CH₂=CH₂</span><span class="moln">Ethene</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>R-CH₂-CH₂-OH</span><span class="sc">Al₂O₃, 350°C</span><span class="sa">⟶</span><span class="sp">R-CH=CH₂</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:var(--ke);color:var(--ke)"><div class="sext">🧠 Catalytic dehydration over alumina</div><div class="sexd">Alcohol vapour passed over heated Al₂O₃ (alumina) or ThO₂ (thoria) at 350–400°C. H₂O eliminated. Alkene-1 is main product from 1°-alcohol. e.g. propan-1-ol → propene · ethanol → ethene.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ke)"><span class="smb2">Method 2</span><span class="smn">Petrol Cracking</span><span class="smtg">Al₂O₃/Cr₂O₃, 500°C — alkane splits</span></div>
<div class="scene" style="color:var(--ke)"><div class="mol"><span class="moli">⛽</span><span class="molf">C₄H₁₀</span><span class="moln">Butane</span></div><div class="sarr"><span class="sat">Al₂O₃/Cr₂O₃</span><span class="sarri">⟶</span><span class="sab">500°C</span></div><div class="mol" style="color:var(--ke)"><span class="moli gw">🌿</span><span class="molf mp">CH₃CH=CH₂</span><span class="moln">Propene</span></div><div class="sop">+</div><div class="mol"><span class="moli">🔥</span><span class="molf" style="color:#6ee7b7">CH₄</span><span class="moln">Methane</span></div></div>
<div class="seq"><span>R-CH₂-CH₂-CH₃</span><span class="sc">Al₂O₃/Cr₂O₃, 500°C</span><span class="sa">⟶</span><span class="sp">R-CH=CH₂</span><span class="sl">+</span><span class="sp">CH₄</span></div>
<div class="sexpl" style="border-color:var(--ke);color:var(--ke)"><div class="sext">🧠 Industrial — higher alkanes → alkene + lower alkane</div><div class="sexd">Petrol vapour (alkane) passed through hot tube with Al₂O₃/Cr₂O₃ catalyst at 500°C in absence of air. Higher alkane breaks into lower alkane + alkene. Dodecane (C₁₂H₂₆) → C₁₀H₂₂ + ethene.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ke)"><span class="smb2">Method 3</span><span class="smn">Alkyne + H₂ → Alkene (Lindlar)</span><span class="smtg">Pd/BaSO₄ (poisoned catalyst), 25°C</span></div>
<div class="scene" style="color:var(--ke)"><div class="mol"><span class="moli">⚡</span><span class="molf">HC≡CH</span><span class="moln">Ethyne</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫙</span><span class="molf">H₂</span><span class="moln">1 mol H₂</span></div><div class="sarr"><span class="sat">Pd/BaSO₄</span><span class="sarri">⟶</span><span class="sab">25°C</span></div><div class="mol" style="color:var(--ke)"><span class="moli gw">🌿</span><span class="molf mp">H₂C=CH₂</span><span class="moln">Ethene (STOPS here)</span></div></div>
<div class="seq"><span>R-C≡CH</span><span class="sl">+</span><span>H₂</span><span class="sc">Pd/BaSO₄, 25°C</span><span class="sa">⟶</span><span class="sp">R-CH=CH₂</span></div>
<div class="sexpl" style="border-color:var(--ke);color:var(--ke)"><div class="sext">🧠 Lindlar's catalyst — STOPS at alkene!</div><div class="sexd">Palladium mixed with BaSO₄ (poisoned catalyst) reduces catalytic power of Pd. Only ONE mole H₂ added → stops at alkene. Without BaSO₄ (plain Pd/Ni), reaction continues to alkane.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ke)"><span class="smb2">Method 4</span><span class="smn">Alkyl Halide + alc.KOH → Alkene</span><span class="smtg">β-Elimination (HX removed)</span></div>
<div class="scene" style="color:var(--ke)"><div class="mol"><span class="moli">🔶</span><span class="molf">CH₃CH₂Cl</span><span class="moln">Ethyl Chloride</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">KOH</span><span class="moln">Alcoholic KOH</span></div><div class="sarr"><span class="sat">alc., Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ke)"><span class="moli gw">🌿</span><span class="molf mp">CH₂=CH₂</span><span class="moln">Ethene</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">KCl+H₂O</span><span class="moln">Byproducts</span></div></div>
<div class="seq"><span>R-CH₂-CH₂-X</span><span class="sl">+</span><span>KOH(alc.)</span><span class="sc">Δ</span><span class="sa">⟶</span><span class="sp">R-CH=CH₂</span><span class="sl">+</span><span class="sp">KX+H₂O</span></div>
<div class="sexpl" style="border-color:var(--ke);color:var(--ke)"><div class="sext">🧠 Saytzeff's rule applies — more substituted alkene is major product</div><div class="sexd">1°-RX → Alkene-1 (terminal). 2°-RX → Alkene-2 (internal, Saytzeff). Key: alc. KOH = elimination. aq. KOH = substitution (alcohol). 1-butyl bromide → butene-1. 2-butyl bromide → butene-2.</div></div></div>
</div>

<!-- Alkyne synth -->
<div id="sc-sy" class="scon">
<div class="schd" style="border-color:var(--ky);color:var(--ky)"><div class="scic">⚡</div><div><div class="sct">Alkyne — CₙH₂ₙ₋₂</div><div class="scs">C≡C triple bond · Alkyne-1 is ACIDIC · C₂–C₄ gas · C₅–C₁₁ liquid · C₁₂+ solid</div></div><div class="scct">4 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--ky)"><span class="smb2">Method 1</span><span class="smn">CaC₂ + H₂O → Ethyne</span><span class="smtg">Lab/industrial method — only gives ethyne!</span></div>
<div class="scene" style="color:var(--ky)"><div class="mol"><span class="moli">🪨</span><span class="molf">CaC₂</span><span class="moln">Calcium Carbide</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf">2H₂O</span><span class="moln">Water</span></div><div class="sarr"><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ky)"><span class="moli gw">⚡</span><span class="molf mp">HC≡CH</span><span class="moln">Ethyne</span></div><div class="sop">+</div><div class="mol"><span class="moli">🪨</span><span class="molf" style="color:#6ee7b7">Ca(OH)₂</span><span class="moln">Slaked lime</span></div></div>
<div class="seq"><span>CaC₂</span><span class="sl">+</span><span>2H₂O</span><span class="sa">⟶</span><span class="sp">HC≡CH</span><span class="sl">+</span><span class="sp">Ca(OH)₂</span></div>
<div class="sexpl" style="border-color:var(--ky);color:var(--ky)"><div class="sext">🧠 Industrial CaC₂ preparation: CaO + 3C → 2500°C → CaC₂ + CO</div><div class="sexd">CaC₂ from coke-carbon + lime at 2500°C in electric furnace. Then CaC₂ + 2H₂O → ethyne at room temp. Large-scale industrial source of acetylene. Always only ethyne (2C) — CaC₂ has 2 carbons.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ky)"><span class="smb2">Method 2</span><span class="smn">Vic-Dihalide + 2KOH(alc.) → Alkyne</span><span class="smtg">Double dehydrohalogenation</span></div>
<div class="scene" style="color:var(--ky)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₂Br–CH₂Br</span><span class="moln">1,2-Dibromoethane (vic)</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">2KOH</span><span class="moln">Alc. KOH</span></div><div class="sarr"><span class="sat">Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ky)"><span class="moli gw">⚡</span><span class="molf mp">HC≡CH</span><span class="moln">Ethyne</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">2KBr+2H₂O</span><span class="moln">Byproducts</span></div></div>
<div class="seq"><span>R-CHX-CHX-R</span><span class="sl">+</span><span>2KOH(alc.)</span><span class="sc">Δ</span><span class="sa">⟶</span><span class="sp">R-C≡C-R</span><span class="sl">+</span><span class="sp">2KX+2H₂O</span></div>
<div class="sexpl" style="border-color:var(--ky);color:var(--ky)"><div class="sext">🧠 Two HX eliminated — two π bonds formed</div><div class="sexd">Gem-dihalide (both X on same C) OR vic-dihalide (X on adjacent C) + 2 alc. KOH → alkyne. 1st KOH removes HX → alkene. 2nd KOH removes HX → alkyne. Needs 2 moles of base.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ky)"><span class="smb2">Method 3</span><span class="smn">Tetrahaloalkane + 2Zn → Alkyne</span><span class="smtg">Zn powder, heat</span></div>
<div class="scene" style="color:var(--ky)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CBr₂-CBr₂CH₃</span><span class="moln">2,2,3,3-tetrabromobutane</span></div><div class="sop">+</div><div class="mol"><span class="moli">⚡</span><span class="molf">2Zn</span><span class="moln">Zinc powder</span></div><div class="sarr"><span class="sat">Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ky)"><span class="moli gw">⚡</span><span class="molf mp">CH₃-C≡C-CH₃</span><span class="moln">Butyne-2</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">2ZnBr₂</span><span class="moln">Zinc bromide</span></div></div>
<div class="seq"><span>R-CBr₂-CBr₂-R</span><span class="sl">+</span><span>2Zn</span><span class="sc">Δ</span><span class="sa">⟶</span><span class="sp">R-C≡C-R</span><span class="sl">+</span><span class="sp">2ZnBr₂</span></div>
<div class="sexpl" style="border-color:var(--ky);color:var(--ky)"><div class="sext">🧠 Vicinal tetrahalide + Zn</div><div class="sexd">Zn removes 2 molecules of Br₂ from adjacent C atoms. Each Zn takes one Br₂. Product is internal alkyne (alkyne-2). Used when alkyne-2 is needed (KOH method gives alkyne-1).</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ky)"><span class="smb2">Method 4</span><span class="smn">From Natural Gas (6CH₄ + O₂)</span><span class="smtg">Partial oxidation at 1500°C</span></div>
<div class="scene" style="color:var(--ky)"><div class="mol"><span class="moli">🔥</span><span class="molf">6 CH₄</span><span class="moln">Methane</span></div><div class="sop">+</div><div class="mol"><span class="moli">💨</span><span class="molf">O₂</span><span class="moln">Oxygen</span></div><div class="sarr"><span class="sat">1500°C</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ky)"><span class="moli gw">⚡</span><span class="molf mp">2HC≡CH</span><span class="moln">Acetylene</span></div><div class="sop">+</div><div class="mol"><span class="moli">💨</span><span class="molf" style="color:#6ee7b7">2CO+10H₂</span><span class="moln">Byproducts</span></div></div>
<div class="seq"><span>6CH₄</span><span class="sl">+</span><span>O₂</span><span class="sc">1500°C</span><span class="sa">⟶</span><span class="sp">2HC≡CH</span><span class="sl">+</span><span class="sp">2CO+10H₂</span></div>
<div class="sexpl" style="border-color:var(--ky);color:var(--ky)"><div class="sext">🧠 Partial oxidation — industrial acetylene from natural gas</div><div class="sexd">Natural gas (methane) partially oxidised at 1500°C. Product stored in propanone (acetone) under high pressure to avoid explosion. Only gives ethyne (acetylene). 3 CH₄ molecules couple to form 1 HC≡CH.</div></div></div>
<div style="background:rgba(192,132,252,.07);border:2px solid rgba(192,132,252,.25);border-radius:14px;padding:1rem 1.2rem;margin:.8rem 0">
  <div style="font-family:'Fredoka One',cursive;color:#c084fc;font-size:1rem;margin-bottom:.6rem">🔬 Identification Tests for Alkyne-1 (acidic H–C≡C–)</div>
  <div style="display:flex;flex-direction:column;gap:.5rem">
    ${[
      {t:'Na metal test',r:'2R–C≡C–H + 2Na(liq.NH₃) → 2R–C≡C–Na + H₂↑','obs':'H₂ gas bubbles — confirms acidic H','col':'#fbbf24'},
      {t:'Ammonical AgNO₃ test','r':'R–C≡C–H + Ag(NH₃)₂NO₃ → R–C≡C–Ag (white ppt) + NH₄NO₃ + NH₃','obs':'White precipitate of silver alkynide','col':'#e2e8f0'},
      {t:'Ammonical Cu₂Cl₂ test','r':'R–C≡C–H + Cu(NH₃)₂Cl → R–C≡C–Cu (red ppt) + NH₄Cl + NH₃','obs':'Red precipitate of copper alkynide','col':'#f87171'}
    ].map(x=>`<div style="background:rgba(0,0,0,.2);border-left:3px solid ${x.col};border-radius:0 8px 8px 0;padding:.5rem .8rem">
      <div style="font-family:'Fredoka One',cursive;color:${x.col};font-size:.82rem">${x.t}</div>
      <div style="font-family:'JetBrains Mono',monospace;font-size:.68rem;color:#7dd3fc;margin:.2rem 0">${x.r}</div>
      <div style="font-size:.72rem;color:#94a3b8">→ ${x.obs}</div>
    </div>`).join('')}
  </div>
  <div style="font-size:.78rem;color:#6b7280;margin-top:.6rem">⚠️ Only alkyne-1 (–C≡C–H) gives these tests. Alkyne-2 (–C≡C–) has NO acidic H so does NOT react!</div>
</div>
</div>

<!-- Alkyl Halide synth -->
<div id="sc-shx" class="scon">
<div class="schd" style="border-color:#a78bfa;color:#a78bfa"><div class="scic">🔶</div><div><div class="sct">Alkyl Halide — R–X</div><div class="scs">Halogen substituent · R–Cl, R–Br, R–I, R–F · Types: 1°, 2°, 3°</div></div><div class="scct">4 Methods</div></div>
<div class="smw"><div class="smto" style="color:#a78bfa"><span class="smb2">Method 1</span><span class="smn">Alcohol + HX → Alkyl Halide</span><span class="smtg">Grouves method (ZnCl₂ dehydrating agent)</span></div>
<div class="scene" style="color:#a78bfa"><div class="mol"><span class="moli">🧪</span><span class="molf">R–OH</span><span class="moln">Alcohol</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">HX(g)</span><span class="moln">HCl / HBr / HI</span></div><div class="sarr"><span class="sat">ZnCl₂</span><span class="sarri">⇌</span></div><div class="mol" style="color:#a78bfa"><span class="moli gw">🔶</span><span class="molf mp">R–X</span><span class="moln">Alkyl Halide</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>R-OH</span><span class="sl">+</span><span>HX</span><span class="sc">anhydrous ZnCl₂</span><span class="sa">⇌</span><span class="sp">R-X</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:#a78bfa;color:#a78bfa"><div class="sext">🧠 Grouves method — ZnCl₂ is Lewis acid dehydrating agent</div><div class="sexd">Reversible reaction. ZnCl₂ absorbs water → drives reaction forward. Reactivity of alcohol: <strong>3° &gt; 2° &gt; 1°</strong>. Reactivity of HX: <strong>HI &gt; HBr &gt; HCl &gt; HF</strong>. Alkyl bromide: 48% HBr + conc. H₂SO₄. Alkyl iodide: 57% HI only (no H₂SO₄ needed).</div></div></div>
<div class="smw"><div class="smto" style="color:#a78bfa"><span class="smb2">Method 2</span><span class="smn">Alcohol + SOCl₂ → Alkyl Chloride</span><span class="smtg">Darzen reaction — PURE product!</span></div>
<div class="scene" style="color:#a78bfa"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂OH</span><span class="moln">Ethanol</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">SOCl₂</span><span class="moln">Thionyl chloride</span></div><div class="sarr"><span class="sarri">⟶</span></div><div class="mol" style="color:#a78bfa"><span class="moli gw">🔶</span><span class="molf mp">CH₃CH₂Cl</span><span class="moln">Ethyl Chloride</span></div><div class="sop">+</div><div class="mol"><span class="moli">💨</span><span class="molf" style="color:#6ee7b7">SO₂+HCl</span><span class="moln">Both gases — escape!</span></div></div>
<div class="seq"><span>R-OH(1°/2°)</span><span class="sl">+</span><span>SOCl₂</span><span class="sa">⟶</span><span class="sp">R-Cl</span><span class="sl">+</span><span class="sp">SO₂(g)+HCl(g)</span></div>
<div class="sexpl" style="border-color:#a78bfa;color:#a78bfa"><div class="sext">🧠 Darzen reaction — SO₂ and HCl both escape as gases → PURE product R–Cl!</div><div class="sexd">Best method for pure alkyl chloride. Byproducts SO₂ and HCl are gases → automatically leave reaction chamber → product R–Cl obtained pure without distillation. Pyridine (C₅H₅N) can absorb HCl gas to drive reaction forward.</div></div></div>
<div class="smw"><div class="smto" style="color:#a78bfa"><span class="smb2">Method 3</span><span class="smn">Alkyl Chloride + AgF → Alkyl Fluoride</span><span class="smtg">Swarts Reaction</span></div>
<div class="scene" style="color:#a78bfa"><div class="mol"><span class="moli">🔶</span><span class="molf">2CH₃CH₂Cl</span><span class="moln">Ethyl Chloride</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">Hg₂F₂</span><span class="moln">Mercurous fluoride</span></div><div class="sarr"><span class="sarri">⟶</span></div><div class="mol" style="color:#a78bfa"><span class="moli gw">🔶</span><span class="molf mp">2CH₃CH₂F</span><span class="moln">Ethyl Fluoride</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">Hg₂Cl₂</span><span class="moln">Byproduct</span></div></div>
<div class="seq"><span>2R-Cl</span><span class="sl">+</span><span>Hg₂F₂</span><span class="sa">⟶</span><span class="sp">2R-F</span><span class="sl">+</span><span class="sp">Hg₂Cl₂</span></div>
<div class="sexpl" style="border-color:#a78bfa;color:#a78bfa"><div class="sext">🧠 Swarts reaction — only way to make alkyl FLUORIDE</div><div class="sexd">Alkyl fluoride CANNOT be made directly from alcohol + HF (reaction too slow). Instead: alkyl chloride + inorganic fluoride (AgF, Hg₂F₂, SbF₃, AsF₃) → alkyl fluoride + metal chloride.</div></div></div>
<div class="smw"><div class="smto" style="color:#a78bfa"><span class="smb2">Method 4</span><span class="smn">Alkene + HX → Alkyl Halide</span><span class="smtg">Markovnikov — 2° alkyl halide major</span></div>
<div class="scene" style="color:#a78bfa"><div class="mol"><span class="moli">🌿</span><span class="molf">CH₃CH=CH₂</span><span class="moln">Propene</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">HBr</span><span class="moln">Hydrogen Bromide</span></div><div class="sarr"><span class="sat">Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:#a78bfa"><span class="moli gw">🔶</span><span class="molf mp">CH₃CHBr–CH₃</span><span class="moln">2-Bromopropane (90%)</span></div></div>
<div class="seq"><span>R-CH=CH₂</span><span class="sl">+</span><span>HX</span><span class="sc">Δ (Markovnikov)</span><span class="sa">⟶</span><span class="sp">R-CHX-CH₃</span></div>
<div class="sexpl" style="border-color:#a78bfa;color:#a78bfa"><div class="sext">🧠 Markovnikov → 2° alkyl halide (major). Anti-Markovnikov (peroxide) → 1° alkyl halide</div><div class="sexd">HX adds across C=C. H goes to C with more H (Markovnikov) → 2° carbocation → 2° alkyl halide (90%). With organic peroxide (R-O-O-R) → free radical → 1° alkyl halide (Kharasch, anti-Markovnikov). HX reactivity: HI &gt; HBr &gt; HCl &gt; HF.</div></div></div>
</div>
<div class="smw"><div class="smto" style="color:var(--ke)"><span class="smb2">Method 1</span><span class="smn">Alkyl Halide + alc.NaOH → Alkene</span><span class="smtg">Alcoholic NaOH, heat</span></div>
<div class="scene" style="color:var(--ke)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃–CH₂Cl</span><span class="moln">Ethyl Chloride</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">NaOH</span><span class="moln">Alcoholic NaOH</span></div><div class="sarr"><span class="sat">alc., Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ke)"><span class="moli gw">🌿</span><span class="molf mp">CH₂=CH₂</span><span class="moln">Ethene</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">NaCl+H₂O</span><span class="moln">Byproducts</span></div></div>
<div class="seq"><span>CH₃–CH₂Cl</span><span class="sl">+</span><span>NaOH</span><span class="sc">alc., heat</span><span class="sa">⟶</span><span class="sp">CH₂=CH₂</span><span class="sl">+</span><span class="sp">NaCl+H₂O</span></div>
<div class="sexpl" style="border-color:var(--ke);color:var(--ke)"><div class="sext">🧠 β-Elimination</div><div class="sexd">Alcoholic NaOH acts as strong base. OH⁻ removes β-H while C–Cl breaks → <strong>HCl eliminated</strong>, electrons form the new <strong>C=C double bond</strong>. Saytzeff's rule: more substituted alkene is major product.</div></div></div>
...
<!-- Alcohol synth -->
<div id="sc-sal" class="scon">
<div class="schd" style="border-color:var(--al);color:var(--al)"><div class="scic">🧪</div><div><div class="sct">Alcohol — CₙH₂ₙ₊₁OH</div><div class="scs">–OH functional group · Hydroxyl</div></div><div class="scct">4 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--al)"><span class="smb2">Method 1</span><span class="smn">Alkyl Halide + aq.NaOH → Alcohol</span><span class="smtg">Aqueous NaOH, heat (SN2)</span></div>
<div class="scene" style="color:var(--al)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂Cl</span><span class="moln">Ethyl Chloride</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫧</span><span class="molf">NaOH</span><span class="moln">Aq. NaOH</span></div><div class="sarr"><span class="sat">aq., Δ</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--al)"><span class="moli gw">🧪</span><span class="molf mp">CH₃CH₂OH</span><span class="moln">Ethanol</span></div><div class="sop">+</div><div class="mol"><span class="moli">🧂</span><span class="molf" style="color:#6ee7b7">NaCl</span><span class="moln">Sodium Chloride</span></div></div>
<div class="seq"><span>CH₃CH₂Cl</span><span class="sl">+</span><span>NaOH</span><span class="sc">aq., heat</span><span class="sa">⟶</span><span class="sp">CH₃CH₂OH</span><span class="sl">+</span><span class="sp">NaCl</span></div>
<div class="sexpl" style="border-color:var(--al);color:var(--al)"><div class="sext">🧠 Nucleophilic Substitution (SN2)</div><div class="sexd">Aqueous OH⁻ is a nucleophile. It attacks the δ+ carbon of C–Cl bond and replaces Cl⁻. <strong>Key: aqueous NaOH → substitution (alcohol). Alcoholic NaOH → elimination (alkene).</strong></div></div></div>
<div class="smw"><div class="smto" style="color:var(--al)"><span class="smb2">Method 2</span><span class="smn">Alkene + H₂O → Alcohol</span><span class="smtg">H₃PO₄, 300°C, 60 atm (Hydration)</span></div>
<div class="scene" style="color:var(--al)"><div class="mol"><span class="moli">🌿</span><span class="molf">CH₂=CH₂</span><span class="moln">Ethene</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf">H₂O</span><span class="moln">Water (steam)</span></div><div class="sarr"><span class="sat">H₃PO₄</span><span class="sarri">⟶</span><span class="sab">300°C, 60atm</span></div><div class="mol" style="color:var(--al)"><span class="moli gw">🧪</span><span class="molf mp">CH₃CH₂OH</span><span class="moln">Ethanol</span></div></div>
<div class="seq"><span>CH₂=CH₂</span><span class="sl">+</span><span>H₂O</span><span class="sc">H₃PO₄, 300°C, 60atm</span><span class="sa">⟶</span><span class="sp">CH₃CH₂OH</span></div>
<div class="sexpl" style="border-color:var(--al);color:var(--al)"><div class="sext">🧠 Hydration (Industrial method)</div><div class="sexd">H⁺ from H₃PO₄ attacks C=C (Markovnikov) → carbonium ion forms → H₂O attacks → protonated alcohol → deprotonation → alcohol. This is the <strong>industrial method</strong> to make ethanol from petroleum ethene.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--al)"><span class="smb2">Method 3</span><span class="smn">Aldehyde + H₂ → 1° Alcohol</span><span class="smtg">Ni, 180–200°C (Reduction)</span></div>
<div class="scene" style="color:var(--al)"><div class="mol"><span class="moli">✨</span><span class="molf">CH₃CHO</span><span class="moln">Ethanal</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫙</span><span class="molf">H₂</span><span class="moln">Hydrogen</span></div><div class="sarr"><span class="sat">Ni</span><span class="sarri">⟶</span><span class="sab">180–200°C</span></div><div class="mol" style="color:var(--al)"><span class="moli gw">🧪</span><span class="molf mp">CH₃CH₂OH</span><span class="moln">Ethanol (1°)</span></div></div>
<div class="seq"><span>CH₃CHO</span><span class="sl">+</span><span>H₂</span><span class="sc">Ni, 180–200°C</span><span class="sa">⟶</span><span class="sp">CH₃CH₂OH</span></div>
<div class="sexpl" style="border-color:var(--al);color:var(--al)"><div class="sext">🧠 Catalytic Reduction</div><div class="sexd">C=O of aldehyde is reduced by H₂. H adds to both C and O of the carbonyl group. Aldehyde → <strong>Primary (1°) alcohol</strong>. Ketone + H₂ → <strong>Secondary (2°) alcohol</strong>.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--al)"><span class="smb2">Method 4</span><span class="smn">Alkyne + H₂O → Aldehyde → Alcohol</span><span class="smtg">2% Hg²⁺, 20% H₂SO₄, 80°C then Ni/H₂</span></div>
<div class="scene" style="color:var(--al)"><div class="mol"><span class="moli">⚡</span><span class="molf">CH≡CH</span><span class="moln">Ethyne</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf">H₂O</span><span class="moln">Water</span></div><div class="sarr"><span class="sat">HgSO₄/H₂SO₄</span><span class="sarri">⟶</span><span class="sab">80°C</span></div><div class="mol"><span class="moli">✨</span><span class="molf">CH₃CHO</span><span class="moln">Ethanal</span></div><div class="sarr"><span class="sat">Ni, H₂</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--al)"><span class="moli gw">🧪</span><span class="molf mp">CH₃CH₂OH</span><span class="moln">Ethanol</span></div></div>
<div class="seq"><span>CH≡CH</span><span class="sl">+</span><span>H₂O</span><span class="sc">HgSO₄, H₂SO₄, 80°C</span><span class="sa">⟶</span><span class="sp">CH₃CHO</span><span class="sc">Ni, H₂</span><span class="sa">⟶</span><span class="sp">CH₃CH₂OH</span></div>
<div class="sexpl" style="border-color:var(--al);color:var(--al)"><div class="sext">🧠 Two-step via Aldehyde</div><div class="sexd">Step 1: Alkyne + H₂O (Wacker) → aldehyde (Markovnikov). Step 2: Aldehyde + H₂ (Ni) → 1° alcohol. Total: alkyne → alcohol in 2 steps.</div></div></div>
</div>

<!-- Aldehyde synth -->
<div id="sc-sad" class="scon">
<div class="schd" style="border-color:var(--ad);color:var(--ad)"><div class="scic">✨</div><div><div class="sct">Aldehyde — RCHO</div><div class="scs">–CHO functional group · Carbonyl at chain end</div></div><div class="scct">3 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--ad)"><span class="smb2">Method 1</span><span class="smn">Primary Alcohol → Aldehyde</span><span class="smtg">K₂Cr₂O₇ / H₂SO₄ (Controlled/Mild Oxidation)</span></div>
<div class="scene" style="color:var(--ad)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂OH</span><span class="moln">Ethanol (1°)</span></div><div class="sop">+</div><div class="mol"><span class="moli">🟠</span><span class="molf">[O]</span><span class="moln">Oxidising agent</span></div><div class="sarr"><span class="sat">K₂Cr₂O₇/H₂SO₄</span><span class="sarri">⟶</span><span class="sab">controlled</span></div><div class="mol" style="color:var(--ad)"><span class="moli gw">✨</span><span class="molf mp">CH₃CHO</span><span class="moln">Ethanal</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>CH₃CH₂OH</span><span class="sl">+</span><span>[O]</span><span class="sc">K₂Cr₂O₇/H₂SO₄</span><span class="sa">⟶</span><span class="sp">CH₃CHO</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:var(--ad);color:var(--ad)"><div class="sext">🧠 Mild/Controlled Oxidation</div><div class="sexd"><strong>Key: must be controlled — stop at aldehyde!</strong> Primary alcohol → aldehyde (remove 2H from –CH₂–OH). If oxidation continues → carboxylic acid. K₂Cr₂O₇ turns from orange → green as Cr³⁺ forms.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ad)"><span class="smb2">Method 2</span><span class="smn">Alkyne + H₂O → Aldehyde</span><span class="smtg">2% Hg²⁺ / 20% H₂SO₄, 80°C (Wacker)</span></div>
<div class="scene" style="color:var(--ad)"><div class="mol"><span class="moli">⚡</span><span class="molf">CH≡CH</span><span class="moln">Ethyne</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf">H₂O</span><span class="moln">Water</span></div><div class="sarr"><span class="sat">2% HgSO₄</span><span class="sarri">⟶</span><span class="sab">20% H₂SO₄, 80°C</span></div><div class="mol" style="color:var(--ad)"><span class="moli gw">✨</span><span class="molf mp">CH₃CHO</span><span class="moln">Ethanal</span></div></div>
<div class="seq"><span>CH≡CH</span><span class="sl">+</span><span>H₂O</span><span class="sc">2% HgSO₄, 20% H₂SO₄, 80°C</span><span class="sa">⟶</span><span class="sp">CH₃CHO</span></div>
<div class="sexpl" style="border-color:var(--ad);color:var(--ad)"><div class="sext">🧠 Wacker Process / Hydration</div><div class="sexd">H₂O adds across the triple bond (Markovnikov). Vinyl alcohol (enol) forms first → rearranges to aldehyde (ethanal). Ethyne → ethanal only. Higher alkynes → ketone (not aldehyde).</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ad)"><span class="smb2">Method 3</span><span class="smn">Fatty Acid → Aldehyde</span><span class="smtg">DIBAL-H, −78°C (Partial Reduction)</span></div>
<div class="scene" style="color:var(--ad)"><div class="mol"><span class="moli">🧬</span><span class="molf">CH₃COOH</span><span class="moln">Ethanoic Acid</span></div><div class="sop">+</div><div class="mol"><span class="moli">🫙</span><span class="molf">2[H]</span><span class="moln">DIBAL-H</span></div><div class="sarr"><span class="sat">DIBAL-H</span><span class="sarri">⟶</span><span class="sab">−78°C</span></div><div class="mol" style="color:var(--ad)"><span class="moli gw">✨</span><span class="molf mp">CH₃CHO</span><span class="moln">Ethanal ⚠️ stop here!</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>CH₃COOH</span><span class="sl">+</span><span>2[H]</span><span class="sc">DIBAL-H, −78°C</span><span class="sa">⟶</span><span class="sp">CH₃CHO</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:var(--ad);color:var(--ad)"><div class="sext">🧠 Partial Reduction (STOP at aldehyde!)</div><div class="sexd">DIBAL-H (diisobutylaluminium hydride) at very low temperature <strong>−78°C</strong> partially reduces –COOH to –CHO. At higher temperature, reduction continues to alcohol. The low temperature is the KEY to stopping at aldehyde.</div></div></div>
</div>

<!-- Fatty Acid synth -->
<div id="sc-sac" class="scon">
<div class="schd" style="border-color:var(--ac);color:var(--ac)"><div class="scic">🧬</div><div><div class="sct">Fatty Acid (Carboxylic Acid) — RCOOH</div><div class="scs">–COOH functional group · Carboxyl group</div></div><div class="scct">3 Methods</div></div>
<div class="smw"><div class="smto" style="color:var(--ac)"><span class="smb2">Method 1</span><span class="smn">Primary Alcohol → Fatty Acid</span><span class="smtg">K₂Cr₂O₇ / H₂SO₄ excess (Strong Oxidation)</span></div>
<div class="scene" style="color:var(--ac)"><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂OH</span><span class="moln">Ethanol (1°)</span></div><div class="sop">+</div><div class="mol"><span class="moli">🟠</span><span class="molf">2[O]</span><span class="moln">Excess oxidant</span></div><div class="sarr"><span class="sat">K₂Cr₂O₇/H₂SO₄</span><span class="sarri">⟶</span><span class="sab">excess</span></div><div class="mol" style="color:var(--ac)"><span class="moli gw">🧬</span><span class="molf mp">CH₃COOH</span><span class="moln">Ethanoic Acid</span></div><div class="sop">+</div><div class="mol"><span class="moli">💧</span><span class="molf" style="color:#6ee7b7">H₂O</span><span class="moln">Water</span></div></div>
<div class="seq"><span>CH₃CH₂OH</span><span class="sl">+</span><span>2[O]</span><span class="sc">K₂Cr₂O₇/H₂SO₄ excess</span><span class="sa">⟶</span><span class="sp">CH₃COOH</span><span class="sl">+</span><span class="sp">H₂O</span></div>
<div class="sexpl" style="border-color:var(--ac);color:var(--ac)"><div class="sext">🧠 Strong Oxidation — goes all the way!</div><div class="sexd"><strong>2 mol [O] needed</strong>. First oxidation: alcohol → aldehyde (−2H). Second oxidation: aldehyde → carboxylic acid (+O). With <strong>excess</strong> K₂Cr₂O₇, reaction goes all the way to –COOH.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ac)"><span class="smb2">Method 2</span><span class="smn">Aldehyde → Fatty Acid</span><span class="smtg">K₂Cr₂O₇ / H₂SO₄ (Oxidation)</span></div>
<div class="scene" style="color:var(--ac)"><div class="mol"><span class="moli">✨</span><span class="molf">CH₃CHO</span><span class="moln">Ethanal</span></div><div class="sop">+</div><div class="mol"><span class="moli">🟠</span><span class="molf">[O]</span><span class="moln">Oxidising agent</span></div><div class="sarr"><span class="sat">K₂Cr₂O₇/H₂SO₄</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ac)"><span class="moli gw">🧬</span><span class="molf mp">CH₃COOH</span><span class="moln">Ethanoic Acid</span></div></div>
<div class="seq"><span>CH₃CHO</span><span class="sl">+</span><span>[O]</span><span class="sc">K₂Cr₂O₇/H₂SO₄</span><span class="sa">⟶</span><span class="sp">CH₃COOH</span></div>
<div class="sexpl" style="border-color:var(--ac);color:var(--ac)"><div class="sext">🧠 Oxidation of Aldehyde</div><div class="sexd">Aldehyde is easily oxidised — the C–H of –CHO breaks and –OH adds to form –COOH. Aldehydes are <strong>stronger reducing agents</strong> than ketones — they give silver mirror test (Tollens) and Fehling's test.</div></div></div>
<div class="smw"><div class="smto" style="color:var(--ac)"><span class="smb2">Method 3</span><span class="smn">Alkene → Aldehyde → Fatty Acid</span><span class="smtg">Via Ozonolysis / Oxidation</span></div>
<div class="scene" style="color:var(--ac)"><div class="mol"><span class="moli">🌿</span><span class="molf">CH₂=CH₂</span><span class="moln">Ethene</span></div><div class="sarr"><span class="sat">H₃PO₄, 300°C</span><span class="sarri">⟶</span></div><div class="mol"><span class="moli">🧪</span><span class="molf">CH₃CH₂OH</span><span class="moln">Ethanol</span></div><div class="sarr"><span class="sat">K₂Cr₂O₇ excess</span><span class="sarri">⟶</span></div><div class="mol" style="color:var(--ac)"><span class="moli gw">🧬</span><span class="molf mp">CH₃COOH</span><span class="moln">Ethanoic Acid</span></div></div>
<div class="seq"><span>CH₂=CH₂</span><span class="sc">H₃PO₄, 300°C</span><span class="sa">⟶</span><span class="sp">CH₃CH₂OH</span><span class="sc">K₂Cr₂O₇ excess</span><span class="sa">⟶</span><span class="sp">CH₃COOH</span></div>
<div class="sexpl" style="border-color:var(--ac);color:var(--ac)"><div class="sext">🧠 Two-step from Alkene</div><div class="sexd">Step 1: Alkene + H₂O (hydration, H₃PO₄) → alcohol. Step 2: alcohol + excess K₂Cr₂O₇ → carboxylic acid. This is the industrial route: <strong>alkene → alcohol → fatty acid</strong>.</div></div></div>
</div>`;
...
<div class="fb-matches">`;
  ...
  const FC_CARDS = [
    ...
    // ── PAGES 91–110 FLASHCARDS ──
    {topic:'Alkane',q:'7 methods to prepare alkane?',a:'1. Decarboxylation (−1C): R-COONa + sodalime → R-H\n2. Wurtz reaction (+C): R-X + 2Na + X-R → R-R (chain doubles!)\n3. Clemmensen reduction: R-CO-R + 4[H] Zn.Hg/HCl → R-CH₂-R\n4. Grignard + H₂O: RMgX + H₂O → R-H\n5. Alkene + H₂: Ni, 180°C\n6. Alkyne + 2H₂: Ni, 180°C\n7. From coal: C+H₂O → 1300°C → CO+H₂ → Ni,300°C → CH₄',hint:'Ascending (Wurtz doubles C), Descending (decarboxylation -1C)'},
    {topic:'Alkane',q:'Wurtz reaction and Clemmensen — key rule?',a:'Wurtz: R-X + 2Na + X-R → R-R + 2NaX. Product has DOUBLE the C of alkyl halide. Ascending method.\nClemmensen: carbonyl + Zn.Hg/conc.HCl → methylene. Product has SAME C count. Ethanal → ethane.',hint:'Wurtz = ascending (C×2), Clemmensen = same C count'},
    {topic:'Alkene',q:'4 methods to prepare alkene?',a:'1. Catalytic dehydration: R-CH₂OH + Al₂O₃/ThO₂, 350-400°C → alkene + H₂O\n2. Petrol cracking: alkane + Al₂O₃/Cr₂O₃, 500°C → alkene + lower alkane\n3. Lindlar: alkyne + H₂ + Pd/BaSO₄, 25°C → alkene (STOPS here!)\n4. HX elimination: R-CH₂X + KOH(alc.) → alkene + KX + H₂O',hint:'Lindlar stops at alkene; plain Ni/Pd goes to alkane'},
    {topic:'Alkene',q:'Two identification tests for alkene?',a:'1. Br₂/CCl₄ (bromine test): red-brown → colourless instantly. CH₂=CH₂ + Br₂ → CH₂Br-CH₂Br\n2. Bayer KMnO₄ test: pink → colourless. CH₂=CH₂ + [O]+H₂O → glycol\nBoth tests confirm unsaturation (C=C or C≡C). Benzene gives NEITHER test.',hint:'Both tests: decolourisation = unsaturated compound'},
    {topic:'Alkyne',q:'3 special identification tests for Alkyne-1 only?',a:'1. Na metal test: 2R-C≡CH + 2Na → 2R-C≡CNa + H₂↑ (H₂ bubbles)\n2. Ammonical AgNO₃: R-C≡CH + Ag(NH₃)₂NO₃ → R-C≡CAg↓ (white ppt)\n3. Ammonical Cu₂Cl₂: R-C≡CH + Cu(NH₃)₂Cl → R-C≡CCu↓ (red ppt)\nAlkyne-2 gives NONE of these tests!',hint:'All 3 tests depend on acidic H of alkyne-1'},
    {topic:'Alkyne',q:'Why is alkyne-1 acidic but alkyne-2 is not?',a:'Alkyne-1: H bonded to sp-hybridised C (s:p=1:1). More s-character → C attracts electrons more → C–H bond weak → H replaceable by Na.\nAlkyne-2 (R-C≡C-R): no H on triple-bonded C → not acidic.\nAlso acetylene > ethylene in acidity because sp > sp² s-character.',hint:'More s-character = more acidic. sp(1:1) > sp²(1:2) > sp³(1:3)'},
    ...
    // ── NEW FLASHCARDS: Aryl Halide, Ether, Amines, Aldehyde, Carboxylic Acid ──
    {topic:'Aryl Halide',q:'4 methods to prepare Aryl Halide (Halogeno Arene)?',a:'1. Halogenation of benzene: C₆H₆ + Cl₂ → AlCl₃/FeBr₃, 80°C → chlorobenzene + HCl\n2. From phenol + PCl₅: C₆H₅OH + PCl₅ → C₆H₅Cl + POCl₃ + HCl\n3. Sandmeyer reaction: C₆H₅N₂Cl + Cu₂Cl₂/HCl, 100°C → C₆H₅Cl + N₂ (with Cu₂Br₂/HBr → bromobenzene)\n4. Chlorotoluene from toluene: + Cl₂ (FeCl₃, no light) → ortho + para chlorotoluene (ring substitution)',hint:'Sandmeyer uses diazonium salt made from aniline at 0-5°C. Aryl halides need Lewis acid carrier (AlCl₃/FeBr₃) unlike alkane halogenation which uses UV light.'},
    {topic:'Aryl Halide',q:'How to identify alkyl halide vs aryl halide?',a:'Alkyl halide (R-Cl): easy hydrolysis with NaOH(aq) → R-OH + Cl⁻. Then Cl⁻ + AgNO₃ → AgCl↓ (white ppt).\nAryl halide (C₆H₅Cl): VERY hard to hydrolyse. Needs 300°C and 150 atm + NaOH.\nAryl halide is resistant because C-Cl bond is strengthened by resonance with benzene π electrons.\nAlternate test: C₆H₅Cl + NH₃/Cu₂S, 200°C, 300 atm → aniline → + CHCl₃/KOH(alc.), 60-70°C → phenyl isocyanide (foul smell).',hint:'Aryl halide C-Cl bond is part of the benzene resonance system → shorter, stronger → much harder to break than alkyl halide C-Cl.'},
    {topic:'Aryl Halide',q:'Uses of haloalkanes — 6 important uses with examples?',a:'1. Solvent: CCl₄, CHCl₃, CH₂Cl₂ dissolve oils and fats\n2. Refrigerant: Freons (CCl₃F = Freon-11, CCl₂F₂ = Freon-12) used in fridges and AC\n3. Fire extinguisher: BCF = CBr₂ClF (dibromo chloro fluoro methane) — heavier than air, smothers fire\n4. Anaesthetic: CHCl₃ (chloroform, 1837 by Dr Simpson); modern = fluothane (2-bromo-2-chloro-1,1,1-trifluoroethane)\n5. Dry cleaning: westrosol = CHCl=CCl₂ (1,1,2-trichloroethylene, bp 90°C) for woollen/synthetic clothes\n6. DDT insecticide: from chlorobenzene + chloral → used 1940–50, then banned internationally (harmful to environment)',hint:'Memory: BCF = fire. Freons = fridge. Westrosol = washing. Chloroform = anaesthetic. DDT = banned pesticide.'},
    {topic:'Ether',q:'Williamson ether synthesis — how does it work and what can it make?',a:'Reaction: R-ONa (sodium alkoxide) + R-X (alkyl halide) → R-O-R + NaX\nSimple ether: C₂H₅ONa + C₂H₅I → C₂H₅-O-C₂H₅ (diethyl ether) + NaI\nMixed ether: C₂H₅ONa + CH₃Br → CH₃-O-C₂H₅ (ethyl methyl ether) + NaBr\nWhy best method: Can make BOTH simple (same R groups) and MIXED (different R groups) ethers. Clean reaction with good yield.\nAlso: dehydration of alcohol: 2C₂H₅OH + conc.H₂SO₄ → 140°C → diethyl ether + H₂O',hint:'Williamson = sodium alkoxide + alkyl halide. The "Na" from the alkoxide grabs the halide, releasing ether. At 170°C+ the same H₂SO₄/alcohol gives alkene instead!'},
    {topic:'Ether',q:'Why is ether stored in a sealed dark bottle, and how do you detect peroxide contamination?',a:'Danger: In sunlight + air, ether reacts with O₂ → explosive, poisonous diethyl peroxide (C₂H₅-O-O-C₂H₅).\nStorage: Use sealed, opaque brown/black bottle — sunlight cannot penetrate. Add small amount of cuprous oxide or hydroquinone (p-dihydroxybenzene) to prevent peroxide formation.\nDetect peroxide: Add KI solution + starch solution and shake. If solution turns BLUE, peroxide is present (it oxidises I⁻ to I₂ which forms blue complex with starch).\nRemove peroxide: Shake ether with FeSO₄ or Na₂SO₃ solution (reducing agents destroy the peroxide before use).',hint:'KI + starch → blue = peroxide present. FeSO₄ or Na₂SO₃ = remove it. Always test ether before using as solvent or anaesthetic!'},
    {topic:'Amines',q:'Carbylamine test — what does it detect and what is the reaction?',a:'Carbylamine test detects PRIMARY AMINES ONLY (1° aliphatic and aromatic)\nReaction: R-NH₂ + CHCl₃ + 3KOH → 60°C → R-N=C (isocyanide/carbylamine — foul, disagreeable smell) + 3KCl + 2H₂O\nAliphatic: CH₃NH₂ → methyl isocyanide (foul smell)\nAromatic: C₆H₅NH₂ (aniline) → phenyl isocyanide (foul smell)\nSecondary and tertiary amines do NOT give this test.\nNote: Chloroform (CHCl₃) is a member of haloform group. Uses of CHCl₃: anaesthetic, solvent, making tear gas (CCl₃–NO₂).',hint:'Carbylamine = 1° amine + CHCl₃ + KOH, 60°C → foul smell. ONLY 1° amines give this. 2° and 3° cannot.'},
    {topic:'Amines',q:'Nitrous acid test — how do 1°, 2°, 3° aliphatic amines and aniline react differently?',a:'HNO₂ is formed in situ: NaNO₂ + HCl → HNO₂ + NaCl\n1° aliphatic (R-NH₂): reacts → N₂ gas bubbles + alcohol (unstable aliphatic diazonium decomposes instantly)\n2° aliphatic (R₂NH): reacts → yellow oily nitroso amine (R₂N-NO) — yellow liquid\n3° aliphatic (R₃N): reacts → water-soluble ammonium nitrite salt — no visible gas or colour change\nAniline (1° aromatic) at 0-5°C: reacts → benzene diazonium chloride (C₆H₅N₂Cl, stable in cold) — used for dyes and Sandmeyer reaction\nAniline at 35°C: diazonium decomposes → phenol + N₂↑',hint:'1° = N₂ bubbles. 2° = yellow oily nitroso amine. 3° = soluble salt. Aniline at 0-5°C = stable diazonium (key exam point!)'},
    {topic:'Aldehyde',q:'Tollen\'s reagent test — what is it, how is it made, and what does it prove?',a:'Tollen\'s reagent: ammoniacal AgNO₃ solution containing diammine silver(I) ion [Ag(NH₃)₂]⁺\nPreparation: AgNO₃(aq) + NaOH → AgOH↓; AgOH + excess NH₄OH → [Ag(NH₃)₂]⁺OH⁻ (colourless clear solution)\nTest: Add 5-6 drops aldehyde + heat at 40°C in hot water bath → shining SILVER MIRROR on inner tube wall\nWhat proves: Silver mirror = aldehyde (–CHO group) is CONFIRMED\nChemical reaction: R-CHO + 2[Ag(NH₃)₂]OH → 2Ag↓ (mirror) + R-COONH₄ + 3NH₃ + H₂O\nKetones CANNOT reduce Tollen\'s — they do NOT form silver mirror',hint:'Silver mirror = aldehyde. No mirror = ketone (or no C=O). Tollen\'s = weak oxidiser, only aldehyde is strong enough reducing agent to reduce it.'},
    {topic:'Aldehyde',q:'Fehling\'s solution test — composition and what does red precipitate confirm?',a:'Composition: Equal volumes of Fehling\'s A (5% CuSO₄, deep blue) + Fehling\'s B (5% sodium-potassium tartarate/Rosselle salt + NaOH, colourless) → blue solution with complex Cu²⁺ (ditartarato cuprate II) ions\nTest: Add aldehyde + heat at 40°C → brick-red precipitate of Cu₂O forms\nWhat proves: Red ppt = aldehyde (–CHO) confirmed. Ketones → NO red ppt.\nReaction: R-CHO + 2Cu(OH)₂ + NaOH → Cu₂O↓ (red) + RCOONa + 3H₂O\nSpecial case: Formic acid (H-COOH) also reduces Fehling\'s (acts as aldehyde too) but does NOT give 2,4-DNP test',hint:'Fehling\'s A = blue CuSO₄. Fehling\'s B = tartarate + NaOH. Red Cu₂O ppt = aldehyde. Ketone = no reaction. Together with Tollen\'s, these two tests definitively confirm aldehyde.'},
    {topic:'Carboxylic Acid',q:'NaHCO₃ test — why is this the most important test for carboxylic acid?',a:'Test: Add carboxylic acid to 5% NaHCO₃ solution → vigorous CO₂ gas bubbles produced\nReaction: R-COOH + NaHCO₃ → RCOONa + CO₂↑ + H₂O\nConfirmation: CO₂ gas turns lime water [Ca(OH)₂] milky → CaCO₃ white precipitate\nWhy most important: Phenol is ALSO acidic (turns litmus red) but phenol is TOO WEAK to react with NaHCO₃ — no CO₂ from phenol.\nSo: RCOOH + NaHCO₃ → CO₂ (YES) but C₆H₅OH + NaHCO₃ → no CO₂ (NO)\nThis single test distinguishes carboxylic acid from phenol — something litmus cannot do.',hint:'RCOOH + NaHCO₃ → CO₂ bubbles. Phenol does NOT. So NaHCO₃ test is the best way to tell carboxylic acid from phenol.'},
    {topic:'Carboxylic Acid',q:'Ester identification — Ferric hydramide test and fruit ester names?',a:'Ferric hydramide test for ester:\n1. Ester + hydroxylamine hydrochloride + dilute NaOH → heat → cool\n2. Add dilute HCl to make acidic\n3. Add 1-2 drops FeCl₃ → reddish-brown colour of ferric hydramide confirms ester\n\nFruit fragrances (esters responsible):\n• Banana = pentyl acetate (CH₃CO.OC₅H₁₁)\n• Orange = octyl acetate (CH₃CO.OC₈H₁₇)\n• Pineapple = butyl butyrate (C₃H₇CO.OC₄H₉)\n• Jasmine flower = benzyl acetate (CH₃CO.OCH₂C₆H₅)',hint:'Ferric hydramide = reddish-brown → ester confirmed. Esters: banana=pentyl acetate, orange=octyl acetate, pineapple=butyl butyrate, jasmine=benzyl acetate.'},
  ];
...
<div class="fc-wrap">
  <div class="fc-filters" id="fc-filters">
    ...
    <button class="fc-filter" onclick="fcFilter('Carboxylic Acid',this)" style="color:#34d399">🧴 Carbox. Acid</button>
...
<div class="nt-wrap">
  <div class="nt-tabs">
    ...
    <button class="nt-tab" style="color:#f43f5e" onclick="ntTab(this,'ar-phanol')">🧪 Phenol & Aniline</button>
  </div>
  ...
  <!-- PHENOL & ANILINE REACTIONS -->
  <div id="ar-phanol" class="nt-pane">
    <div class="note-card"><div class="note-card-head" style="border-color:#f43f5e"><span class="note-card-icon">🧪</span><span class="note-card-title" style="color:#f43f5e">Phenol (C₆H₅OH) Reactions — ortho-para directing</span></div>
    <div class="note-card-body">
      –OH group has <strong>positive mesomeric (+M) effect</strong> → pushes lone pair into ring → increases electron density at ortho+para positions → phenol is MORE reactive than benzene.<br><br>
      <strong>1. Nitration of Phenol (20–25°C, dilute HNO₃ only!):</strong>
      <div class="note-formula">2 C₆H₅OH + 2HO–NO₂ → 20–25°C → ortho-nitrophenol + para-nitrophenol + 2H₂O</div>
      Benzene needs 60°C + conc. HNO₃ + conc. H₂SO₄. Phenol only needs dilute HNO₃ at room temp — proves –OH activates the ring!<br><br>
      <strong>2. Picric Acid from Phenol (conc. HNO₃ + conc. H₂SO₄, heat):</strong>
      <div class="note-formula">C₆H₅OH + 3HO–NO₂ → conc.H₂SO₄, Δ → 2,4,6-trinitrophenol (picric acid) + 3H₂O</div>
      All 3 nitro groups enter at once. Picric acid = yellow solid, used as antiseptic for skin burns.<br><br>
      <strong>3. Halogenation of Phenol (25°C, no halogen carrier needed!):</strong>
      <div class="note-formula">C₆H₅OH + 3Br₂(aq) → 25°C → 2,4,6-tribromophenol (yellow-white ppt) + 3HBr</div>
      Benzene needs AlCl₃/FeBr₃ carrier. Phenol reacts without carrier at 25°C — proves phenol is far more reactive than benzene. This reaction is used to <strong>identify phenol</strong>. Bromine water is decolourised.
    </div></div>

    <div class="note-card"><div class="note-card-head" style="border-color:#a78bfa"><span class="note-card-icon">🟣</span><span class="note-card-title" style="color:#a78bfa">Aniline (C₆H₅NH₂) Reactions — ortho-para directing</span></div>
    <div class="note-card-body">
      –NH₂ group has <strong>positive mesomeric (+M) effect</strong> → pushes lone pair into ring → aniline is more reactive than benzene.<br><br>
      <strong>1. Halogenation of Aniline (25°C, no carrier):</strong>
      <div class="note-formula">C₆H₅NH₂ + 3Br₂(aq) → 25°C → 2,4,6-tribromoaniline (white ppt) + 3HBr</div>
      Same pattern as phenol — reacts at 25°C without carrier. Gives white precipitate. Used to identify aniline.<br><br>
      <strong>2. Nitration of Aniline (⚠️ gives META product!):</strong>
      <div class="note-formula">C₆H₅NH₂ + HNO₃ → conc.H₂SO₄, 60–70°C → m-nitroaniline</div>
      <div style="background:rgba(248,113,113,.08);border-left:3px solid #f87171;padding:.5rem .8rem;border-radius:0 8px 8px 0;margin:.4rem 0">
        ⚠️ <strong>Why META?</strong> –NH₂ is ortho-para directing BUT in acidic medium (conc. HNO₃ + H₂SO₄), aniline is protonated: C₆H₅NH₂ + H⁺ → C₆H₅NH₃⁺ (anilinium ion). The –NH₃⁺ group is META directing! So meta-nitroaniline is formed.
      </div>
      To get ortho-para product: first acetylate (–NH₂ → –NHCOCH₃ = acetanilide) then nitrate at 30°C → ortho (5%) + para (95%) nitroacetanilide → then hydrolyse with dil.H₂SO₄ → ortho-para nitroaniline.<br><br>
      <strong>3. Sulphonation of Aniline (fuming H₂SO₄, 180–200°C):</strong>
      <div class="note-formula">C₆H₅NH₂ + HO–SO₃H → SO₃, 180°C → 4-aminobenzenesulphonic acid (sulphanilic acid) + H₂O</div>
      Sulphanilic acid forms a <strong>zwitter-ion</strong> in water because it has both basic –NH₂ and acidic –SO₃H groups in same molecule: H₂N–C₆H₄–SO₃H ⇌ H₃N⁺–C₆H₄–SO₃⁻ (zwitter ion).
    </div></div>

    <div class="note-card"><div class="note-card-head" style="border-color:#fbbf24"><span class="note-card-icon">⚡</span><span class="note-card-title" style="color:#fbbf24">Nitrobenzene Further Reactions — meta directing</span></div>
    <div class="note-card-body">
      –NO₂ group has <strong>negative mesomeric (–M) effect</strong> → withdraws electrons from ring → deactivates ring → electrophile goes to meta.<br><br>
      <strong>Further nitration of nitrobenzene (100°C required!):</strong>
      <div class="note-formula">2 C₆H₅NO₂ + HNO₃ → conc.H₂SO₄, 100°C, Δ → m-dinitrobenzene + H₂O</div>
      Benzene nitration: 60°C. But nitrobenzene is deactivated → needs 100°C for further nitration. Product is always <strong>meta</strong>-dinitrobenzene.<br><br>
      <strong>Key comparison table:</strong>
      <table class="note-table">
        <tr><th>Compound</th><th>Group effect</th><th>Directs to</th><th>More/Less reactive</th></tr>
        <tr><td style="color:#4ade80">Toluene (–CH₃)</td><td>+I</td><td>ortho + para</td><td>More reactive (30°C)</td></tr>
        <tr><td style="color:#60a5fa">Phenol (–OH)</td><td>+M</td><td>ortho + para</td><td>Much more reactive (RT)</td></tr>
        <tr><td style="color:#c084fc">Aniline (–NH₂)</td><td>+M</td><td>ortho + para*</td><td>Much more reactive (RT)</td></tr>
        <tr><td style="color:#f87171">Nitrobenzene (–NO₂)</td><td>–M</td><td>meta</td><td>Less reactive (100°C)</td></tr>
      </table>
      *aniline gives meta in acid due to anilinium ion formation
    </div></div>

    <div class="note-card"><div class="note-card-head" style="border-color:#34d399"><span class="note-card-icon">🔑</span><span class="note-card-title" style="color:#34d399">Alkyne-1 Identification Tests (3 unique tests)</span></div>
    <div class="note-card-body">
      Alkyne-1 (R–C≡C–H) has <strong>mildly acidic H</strong> on the triple-bonded carbon (sp hybrid, high s-character). This gives 3 special tests that <strong>differentiate alkyne-1 from alkyne-2</strong>:<br><br>
      <strong>1. Sodium Metal Test → H₂ bubbles:</strong>
      <div class="note-formula">2R–C≡C–H + 2Na → liquid NH₃ → 2R–C≡C–Na + H₂ ↑</div>
      <strong>2. Ammonical AgNO₃ Test → white precipitate:</strong>
      <div class="note-formula">R–C≡C–H + Ag(NH₃)₂NO₃ → R–C≡C–Ag↓ (silver alkynide, white ppt) + NH₄NO₃ + NH₃</div>
      <strong>3. Ammonical Cu₂Cl₂ Test → red precipitate:</strong>
      <div class="note-formula">R–C≡C–H + Cu(NH₃)₂Cl → R–C≡C–Cu↓ (copper alkynide, red ppt) + NH₄Cl + NH₃</div>
      <div style="background:rgba(251,191,36,.08);border-left:3px solid #fbbf24;padding:.5rem .8rem;border-radius:0 8px 8px 0;margin:.4rem 0;font-size:.82rem">
        ⚠️ Alkyne-2 (R–C≡C–R) has NO acidic H → gives NONE of the above 3 tests. So these tests differentiate alkyne-1 from alkyne-2. Also, acetylene is more acidic than ethylene because sp C–H bond is weaker (more s-character) than sp² C–H bond.
      </div>
    </div></div>
  </div>
</div>`;
  ...
  const QB = [
    ...
    // ── FROM PAGES 91–110 ──
    {t:"Arenes",q:"Phenol + 3Br₂(aq) at 25°C (no carrier) gives?",o:["Bromobenzene","2,4,6-tribromophenol (yellow-white ppt) + 3HBr","Monobromophenol only","No reaction without carrier"],a:1,e:"C₆H₅OH + 3Br₂(aq) → 25°C → 2,4,6-tribromophenol (yellow-white ppt) + 3HBr. Phenol reacts at 25°C WITHOUT halogen carrier because –OH group activates the ring greatly. Used to IDENTIFY phenol."},
    {t:"Arenes",q:"Phenol + conc.HNO₃ + conc.H₂SO₄ gives which compound (used as antiseptic)?",o:["Nitrobenzene","Benzaldehyde","Picric acid (2,4,6-trinitrophenol)","Benzoic acid"],a:2,e:"C₆H₅OH + 3HO–NO₂ → conc.H₂SO₄, Δ → picric acid (2,4,6-trinitrophenol) + 3H₂O. Picric acid = yellow solid used as antiseptic for skin burns."},
    {t:"Arenes",q:"Nitration of phenol at 20–25°C with dilute HNO₃ gives?",o:["Meta-nitrophenol only","Ortho-nitrophenol + para-nitrophenol","Trinitrophenol","No reaction"],a:1,e:"Phenol + dilute HNO₃ at 20–25°C → ortho-nitrophenol + para-nitrophenol. Proves –OH group activates ring (benzene needs 60°C + conc. reagents but phenol reacts at room temperature with dilute acid)."},
    {t:"Arenes",q:"Aniline + 3Br₂(aq) at 25°C gives?",o:["Bromobenzene","Monobromaniline","2,4,6-tribromoaniline (white ppt) + 3HBr","No reaction without catalyst"],a:2,e:"C₆H₅NH₂ + 3Br₂(aq) → 25°C → 2,4,6-tribromoaniline (white precipitate) + 3HBr. Like phenol, aniline reacts at room temperature without carrier. Used to IDENTIFY aniline."},
    {t:"Arenes",q:"Nitration of aniline with conc.HNO₃ + conc.H₂SO₄ gives which positional isomer? Why?",o:["Ortho-nitroaniline","Para-nitroaniline","Meta-nitroaniline","Equal mixture of all three"],a:2,e:"Aniline in acid medium is protonated: C₆H₅NH₂ + H⁺ → C₆H₅NH₃⁺ (anilinium ion). –NH₃⁺ group is META-directing! So meta-nitroaniline forms. Note: –NH₂ is normally ortho-para directing but acid converts it to meta-directing –NH₃⁺."},
    {t:"Arenes",q:"Sulphonation of aniline with fuming H₂SO₄ at 180–200°C gives?",o:["Ortho-aniline sulphonic acid","4-aminobenzenesulphonic acid (sulphanilic acid)","Benzene sulphonic acid","Nitroaniline"],a:1,e:"C₆H₅NH₂ + HO–SO₃H → SO₃, 180°C → 4-aminobenzenesulphonic acid (sulphanilic acid) + H₂O. Sulphanilic acid forms a ZWITTER-ION in water because it has both –NH₂ (basic) and –SO₃H (acidic) groups."},
    {t:"Arenes",q:"Further nitration of nitrobenzene occurs at which temperature and gives which product?",o:["60°C → ortho-dinitrobenzene","100°C → meta-dinitrobenzene","30°C → para-dinitrobenzene","50°C → ortho-dinitrobenzene"],a:1,e:"Nitrobenzene (deactivated by –NO₂) needs 100°C for further nitration → m-dinitrobenzene. Compare: benzene nitration at 60°C. –NO₂ withdraws electrons (–M effect) → meta-directing → deactivates ring."},
    {t:"Alkane",q:"Alkane is called paraffin. What does paraffin mean?",o:["High reactivity","Parum affinis = little affinity to react","Flammable always","Latin for carbon"],a:1,e:"Paraffin comes from Latin 'parum affinis' meaning 'little affinity to react'. Alkanes are very unreactive — they don't react with acid, base, or general reagents. Only react with O₂ (combustion) and halogens."},
    {t:"Alkane",q:"Wurtz reaction: 2 mol CH₃I + 2Na in dry ether gives?",o:["CH₄ (methane)","CH₃–CH₃ (ethane)","CH₃–CH₂–CH₃ (propane)","CH₄ + NaI"],a:1,e:"CH₃I + 2Na + ICH₃ → dry ether → CH₃–CH₃ (ethane) + 2NaI. Wurtz reaction: carbon chain DOUBLES! 1C alkyl halide → 2C alkane. Used to prepare HIGHER homologues. Ascending method."},
    {t:"Alkane",q:"Clemmensen's reduction converts carbonyl group (C=O) to?",o:["Alcohol (C–OH)","Carboxylic acid (COOH)","Methylene group (–CH₂–) → alkane","Aldehyde"],a:2,e:"Clemmensen's reduction: R–C=O + 4[H] → Zn.Hg/conc.HCl → R–CH₂–R + H₂O. Carbonyl (–CO–) directly reduced to methylene (–CH₂–). Product alkane has SAME number of carbons as starting compound. Ethanal → ethane."},
    {t:"Alkane",q:"Petrol synthesis (Fischer-Tropsch): nCO + (2n+1)H₂ with Co catalyst at 200°C, 5-10 atm gives?",o:["Methane only","Liquid alkane (CₙH₂ₙ₊₂) + nH₂O","Carbon dioxide","Coal"],a:1,e:"nCO + (2n+1)H₂ → Co catalyst, 200°C, 5–10 atm → CₙH₂ₙ₊₂ (liquid alkane) + nH₂O. CO and H₂ mixture (water gas from coke+steam) is converted to liquid hydrocarbons. This is the industrial Fischer-Tropsch synthesis."},
    {t:"Alkane",q:"Complete combustion of methane gives?",o:["CO + H₂O","CO₂ + H₂O + heat (ΔH = −802 kJ/mol)","C (carbon soot) + CO","CH₃OH"],a:1,e:"CH₄ + 2O₂ → CO₂ + 2H₂O, ΔH = −802 kJ/mol. Complete combustion in sufficient air gives CO₂ + H₂O + heat. Incomplete combustion in limited air gives CO, carbon soot and CO₂."},
    {t:"Alkene",q:"Alkene preparation from alcohol vapour over Al₂O₃ at 350–400°C is called?",o:["Halogenation","Catalytic dehydration","Clemmensen's reduction","Wurtz reaction"],a:1,e:"Alcohol vapour passed over Al₂O₃ (alumina) or ThO₂ (thoria) at 350–400°C → alkene + H₂O. This is catalytic DEHYDRATION. e.g. Propan-1-ol → propene + H₂O. Alkene-1 is main product from 1°-alcohol."},
    {t:"Alkene",q:"Petrol cracking (Al₂O₃/Cr₂O₃, 500°C) converts alkane to?",o:["Alkyne only","Lower alkane + alkene","Alcohol + CO₂","Alkene only"],a:1,e:"R-CH₂-CH₂-CH₃ → Al₂O₃/Cr₂O₃, 500°C → R-CH=CH₂ (alkene) + CH₄ (lower alkane). Higher alkanes from petroleum crack into useful alkene + lower alkane. Butane → propene + methane."},
    {t:"Alkene",q:"Lindlar's catalyst (Pd/BaSO₄) reduces alkyne to alkene because?",o:["BaSO₄ increases catalytic power","BaSO₄ poisons (reduces) Pd catalytic power — reaction stops at alkene","Temperature is higher","AlCl₃ is added"],a:1,e:"Pd/BaSO₄ at 25°C: BaSO₄ POISONS the Pd catalyst, reducing its activity so only ONE mole H₂ adds across ONE π bond → alkene. Without BaSO₄ (plain Pd or Ni), full hydrogenation continues to alkane."},
    {t:"Alkene",q:"Bromine solution test for alkene: Br₂ in CCl₄ is which colour initially?",o:["Yellow","Colourless","Red-brown (5% Br₂ solution)","Blue"],a:2,e:"Bromine is dissolved in CCl₄ to make red-brown 5% Br₂ solution. When added to alkene, colour disappears instantly: CH₂=CH₂ + Br₂ → CH₂Br–CH₂Br (colourless). This is the unsaturation test."},
    {t:"Alkene",q:"Bayer's KMnO₄ test: ethene + alkaline KMnO₄ gives?",o:["Carboxylic acid","Ethylene glycol (HOCH₂–CH₂OH) — pink colour disappears","Ethanal","No reaction"],a:1,e:"CH₂=CH₂ + [O] + H₂O → KMnO₄/KOH → HOCH₂–CH₂OH (ethylene glycol). Pink KMnO₄ becomes colourless as Mn is reduced. Confirms unsaturation. Alkyne → oxalic acid with KMnO₄."},
    {t:"Alkyne",q:"Alkyne-1 vs Alkyne-2: which is acidic and why?",o:["Both equally acidic","Alkyne-2 only","Alkyne-1 — H on sp-C is acidic (sp orbital has more s-character, weak C–H bond)","Alkyne-2 — more stable"],a:2,e:"Alkyne-1 (R–C≡C–H) is ACIDIC. The C is sp-hybridised (s:p = 1:1), making the C–H bond weak. This H can be replaced by active metals. Alkyne-2 (R–C≡C–R) has NO terminal H → not acidic."},
    {t:"Alkyne",q:"Alkyne-1 + ammonical AgNO₃ solution gives?",o:["No reaction","Yellow ppt","White precipitate of silver alkynide (R–C≡C–Ag)","Red ppt of copper alkynide"],a:2,e:"R–C≡C–H + Ag(NH₃)₂NO₃ → R–C≡C–Ag↓ (white ppt of silver alkynide) + NH₄NO₃ + NH₃. ONLY alkyne-1 gives this test — used to IDENTIFY alkyne-1 and differentiate from alkyne-2."},
    {t:"Alkyne",q:"Alkyne-1 + ammonical Cu₂Cl₂ solution gives?",o:["White ppt of silver alkynide","Red precipitate of copper alkynide (R–C≡C–Cu)","Blue colour","Yellow ppt"],a:1,e:"R–C≡C–H + Cu(NH₃)₂Cl → R–C≡C–Cu↓ (red ppt of copper alkynide) + NH₄Cl + NH₃. The RED colour is a characteristic test for alkyne-1. Alkyne-2 gives NO reaction."},
    {t:"Alkyne",q:"Alkyne-1 + Na metal in liquid ammonia gives?",o:["Red ppt","White ppt","H₂ gas bubbles + sodium alkynide","No reaction"],a:2,e:"2R–C≡C–H + 2Na → liquid NH₃ → 2R–C≡C–Na (sodium alkynide) + H₂ ↑. H₂ bubbles evolve. Only alkyne-1 reacts — confirms its acidic property. Ethylene/propene do NOT respond."},
    {t:"Alkyne",q:"Why is acetylene (HC≡CH) more acidic than ethylene (H₂C=CH₂)?",o:["Acetylene has more H","sp hybridised C has more s-character (s:p=1:1) → weaker C–H bond than sp² in ethylene","Acetylene is larger","No reason"],a:1,e:"In ethyne, C is sp hybrid (s:p=1:1). In ethene, C is sp² (s:p=1:2). More s-character → electrons closer to nucleus → C–H bond weaker and more polar → H more easily replaced by Na. So acetylene is more acidic."},
    {t:"Alkyne",q:"Industrial preparation of acetylene (ethyne) from CaC₂: first step involves?",o:["Burning coal","CaCO₃→CaO then CaO+3C → 2500°C → CaC₂+CO, then CaC₂+2H₂O→HC≡CH+Ca(OH)₂","Direct from methane","Fermentation"],a:1,e:"Step 1: CaCO₃ → CaO + CO₂. Step 2: CaO + 3C → 2500°C (electric furnace) → CaC₂ + CO. Step 3 (lab): CaC₂ + 2H₂O → HC≡CH + Ca(OH)₂. Large-scale: hydrolysis of CaC₂."},
    {t:"Alkyne",q:"Separation of ethane+ethene+ethyne mixture: first step is?",o:["Pass through conc.H₂SO₄ to absorb ethene","Pass through ammonical Cu₂Cl₂ → ethyne absorbed as red ppt, ethane+ethene pass out","Heat mixture","Pass through NaOH"],a:1,e:"Step 1: pass through Cu(NH₃)₂Cl → ethyne gives red ppt copper alkynide. Ethane+ethene pass out. Step 2: ethane+ethene passed through conc.H₂SO₄ → ethene absorbed as ethyl hydrogen sulphate. Ethane bubbles out. Step 3: heat ppt + HCl → recover ethyne."},
    {t:"Alkane",q:"Alkyl halide preparation from alcohol + HX: the reaction is reversible. What is used to make it go forward?",o:["Water","Anhydrous ZnCl₂ or conc.H₂SO₄ as dehydrating/water-absorbing agent","NaOH","Heat only"],a:1,e:"R–OH + HX ⇌ R–X + H₂O. To push equilibrium forward, water is removed using anhydrous ZnCl₂ (Lewis acid, Grouve's method) or conc.H₂SO₄. ZnCl₂ absorbs water and also activates the –OH group."},
...
/* ═══════════════════════════════════════════════════════════════════
   CHEMICAL PROPERTIES PATCH — added inline to chemistry_ch11.js
   Runs after the IIFE renders panels into DOM, then appends
   the properties/reactions HTML directly to each hydrocarbon panel.
═══════════════════════════════════════════════════════════════════ */
(function injectChemProps() {
  function append(panelId, html) {
  ...
  function run() {
    append('ka', '\n<div style="margin-top:1.5rem;border-top:2px dashed rgba(255,112,67,.35);padding-top:1.4rem">\n<div style="font-family:\'Fredoka One\',cursive;font-size:1.15rem;color:var(--ka);margin-bottom:.9rem">🧪 Chemical Properties &amp; Reactions</div>\n<div style="display:flex;gap:.7rem;flex-wrap:wrap;margin-bottom:1rem">\n  <div style="flex:1;min-width:195px;background:rgba(248,113,113,.07);border:1.5px solid rgba(248,113,113,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#f87171;font-size:.88rem;margin-bottom:.35rem">🧪 Bromine Water Test — ❌ NEGATIVE</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.75rem;margin-bottom:.3rem"><span style="background:#d4a017;color:#fff;padding:1px 7px;border-radius:4px">Br₂(aq)</span> <span style="color:#e2e8f0">→</span> <span style="background:#d4a017;color:#fff;padding:1px 7px;border-radius:4px">No change</span></div>\n    <div style="font-size:.76rem;color:#94a3b8">Alkanes do NOT decolourise Br₂ — no π bond.</div>\n  </div>\n  <div style="flex:1;min-width:195px;background:rgba(248,113,113,.07);border:1.5px solid rgba(248,113,113,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#f87171;font-size:.88rem;margin-bottom:.35rem">🧪 Baeyer\'s KMnO₄ Test — ❌ NEGATIVE</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.75rem;margin-bottom:.3rem"><span style="background:#7b1fa2;color:#fff;padding:1px 7px;border-radius:4px">KMnO₄ purple</span> <span style="color:#e2e8f0">→</span> <span style="background:#7b1fa2;color:#fff;padding:1px 7px;border-radius:4px">Remains purple</span></div>\n    <div style="font-size:.76rem;color:#94a3b8">No oxidation — KMnO₄ stays purple with alkanes.</div>\n  </div>\n</div>\n<div class="rb" style="border:1.5px solid rgba(255,112,67,.22);background:rgba(255,112,67,.04)"><div class="rl" style="color:var(--ka)">REACTION 1 · COMBUSTION</div><div class="rn">Complete &amp; Incomplete Combustion</div><div style="font-size:.8rem;color:#94a3b8;margin:.3rem 0;font-weight:700">Complete combustion (excess O₂):</div><div class="eq"><span class="r">CH₄ + 2O₂</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">CO₂ + 2H₂O + heat</span></div><div style="font-size:.8rem;color:#94a3b8;margin:.45rem 0 .3rem;font-weight:700">Incomplete combustion (limited O₂):</div><div class="eq"><span class="r">2CH₄ + 3O₂</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">2CO + 4H₂O</span></div><div class="note" style="border-color:var(--ka)">CO (carbon monoxide) = colourless, odourless, toxic gas.</div></div>\n<div class="rb" style="border:1.5px solid rgba(255,112,67,.22);background:rgba(255,112,67,.04)"><div class="rl" style="color:var(--ka)">REACTION 2 · HALOGENATION — Free Radical Substitution (UV Light)</div><div class="rn">CH₄ + Cl₂ → CH₃Cl + HCl (UV)</div><div class="eq"><span class="r">CH₄ + Cl₂</span><div class="ab"><span class="ct">UV (hν)</span><span class="arr">⟶</span></div><span class="prod">CH₃Cl + HCl</span></div><div style="font-family:\'Fredoka One\',cursive;font-size:.85rem;color:#f97316;margin:.6rem 0 .4rem">Mechanism — 3 Steps:</div><div style="display:flex;flex-direction:column;gap:.4rem"><div style="display:flex;gap:.65rem;align-items:flex-start;background:rgba(0,0,0,.2);border-radius:8px;padding:.5rem .75rem"><div style="background:#f97316;color:#fff;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">1</div><div style="font-size:.8rem;color:#94a3b8"><span style="color:#fbbf24;font-weight:800">Initiation:</span> UV breaks Cl–Cl → 2 Cl• (free radicals)<br><span style="font-family:\'JetBrains Mono\',monospace;font-size:.72rem;color:#7dd3fc">Cl₂ + hν → 2Cl•</span></div></div><div style="display:flex;gap:.65rem;align-items:flex-start;background:rgba(0,0,0,.2);border-radius:8px;padding:.5rem .75rem"><div style="background:#f97316;color:#fff;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">2</div><div style="font-size:.8rem;color:#94a3b8"><span style="color:#fbbf24;font-weight:800">Propagation</span> (repeating):<br><span style="font-family:\'JetBrains Mono\',monospace;font-size:.72rem;color:#7dd3fc">Cl• + CH₄ → CH₃• + HCl<br>CH₃• + Cl₂ → CH₃Cl + Cl•</span></div></div><div style="display:flex;gap:.65rem;align-items:flex-start;background:rgba(0,0,0,.2);border-radius:8px;padding:.5rem .75rem"><div style="background:#f97316;color:#fff;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">3</div><div style="font-size:.8rem;color:#94a3b8"><span style="color:#fbbf24;font-weight:800">Termination</span> — radicals combine:<br><span style="font-family:\'JetBrains Mono\',monospace;font-size:.72rem;color:#7dd3fc">Cl•+Cl• → Cl₂ &nbsp;|&nbsp; CH₃•+Cl• → CH₃Cl</span></div></div></div></div>\n<div class="rb" style="border:1.5px solid rgba(255,112,67,.22);background:rgba(255,112,67,.04)"><div class="rl" style="color:var(--ka)">REACTION 3 · THERMAL CRACKING</div><div class="eq"><span class="r">C₁₀H₂₂</span><div class="ab"><span class="ct">Al₂O₃, heat</span><span class="arr">⟶</span></div><span class="prod">C₅H₁₂ + C₅H₁₀</span></div><div class="note" style="border-color:var(--ka)">Used in petroleum industry to get petrol from heavy oil.</div></div>\n<div class="rb" style="border:1.5px solid rgba(255,112,67,.22);background:rgba(255,112,67,.04)"><div class="rl" style="color:var(--ka)">REACTION 4 · NITRATION (Industrial)</div><div class="eq"><span class="r">CH₄ + HNO₃</span><div class="ab"><span class="ct">400–500°C</span><span class="arr">⟶</span></div><span class="prod">CH₃NO₂ + H₂O</span></div><div class="wd">Produces nitroalkanes — important in explosives &amp; amine synthesis.</div></div>\n</div>');
    append('ke', '\n<div style="margin-top:1.5rem;border-top:2px dashed rgba(0,229,160,.35);padding-top:1.4rem">\n<div style="font-family:\'Fredoka One\',cursive;font-size:1.15rem;color:var(--ke);margin-bottom:.9rem">🧪 Chemical Properties &amp; Reactions</div>\n<div style="display:flex;gap:.7rem;flex-wrap:wrap;margin-bottom:1rem">\n  <div style="flex:1;min-width:195px;background:rgba(74,222,128,.07);border:1.5px solid rgba(74,222,128,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#4ade80;font-size:.88rem;margin-bottom:.35rem">🧪 Bromine Water — ✅ POSITIVE</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.75rem;margin-bottom:.3rem"><span style="background:#d4a017;color:#fff;padding:1px 7px;border-radius:4px">Br₂(aq) orange-brown</span> <span style="color:#e2e8f0">→</span> <span style="background:#f5f5f5;color:#555;padding:1px 7px;border-radius:4px">Colourless</span></div>\n    <div style="font-size:.76rem;color:#94a3b8">Alkene decolourises Br₂ — confirms C=C double bond.</div>\n  </div>\n  <div style="flex:1;min-width:195px;background:rgba(74,222,128,.07);border:1.5px solid rgba(74,222,128,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#4ade80;font-size:.88rem;margin-bottom:.35rem">🧪 Baeyer\'s KMnO₄ — ✅ POSITIVE</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.75rem;margin-bottom:.3rem"><span style="background:#7b1fa2;color:#fff;padding:1px 7px;border-radius:4px">KMnO₄ purple</span> <span style="color:#e2e8f0">→</span> <span style="background:#795548;color:#fff;padding:1px 7px;border-radius:4px">Brown ppt MnO₂</span></div>\n    <div style="font-size:.76rem;color:#94a3b8">KMnO₄ oxidises C=C; purple → brown MnO₂.</div>\n  </div>\n</div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 1 · BROMINE ADDITION — Electrophilic Addition</div><div class="rn">Ethene + Br₂ → 1,2-Dibromoethane</div><div class="eq"><span class="r">CH₂=CH₂ + Br₂</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">CH₂Br–CH₂Br</span></div><div style="font-family:\'Fredoka One\',cursive;font-size:.83rem;color:var(--ke);margin:.55rem 0 .35rem">Mechanism:</div><div style="display:flex;flex-direction:column;gap:.35rem"><div style="display:flex;gap:.65rem;background:rgba(0,0,0,.2);border-radius:8px;padding:.45rem .7rem"><div style="background:var(--ke);color:#002a22;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">1</div><div style="font-size:.8rem;color:#94a3b8">π electrons attract Br₂; Br–Br polarises → Brδ⁺–Brδ⁻</div></div><div style="display:flex;gap:.65rem;background:rgba(0,0,0,.2);border-radius:8px;padding:.45rem .7rem"><div style="background:var(--ke);color:#002a22;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">2</div><div style="font-size:.8rem;color:#94a3b8">Brδ⁺ attacks π bond → bromonium ion intermediate</div></div><div style="display:flex;gap:.65rem;background:rgba(0,0,0,.2);border-radius:8px;padding:.45rem .7rem"><div style="background:var(--ke);color:#002a22;border-radius:50%;width:21px;height:21px;min-width:21px;display:flex;align-items:center;justify-content:center;font-family:\'Fredoka One\',cursive;font-size:.7rem">3</div><div style="font-size:.8rem;color:#94a3b8">Br⁻ attacks back side → anti-addition → trans product</div></div></div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 2 · BAEYER\'S REAGENT (Cold dilute KMnO₄)</div><div class="eq"><span class="r">3CH₂=CH₂ + 2KMnO₄ + 4H₂O</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">3HOCH₂–CH₂OH + 2MnO₂↓ + 2KOH</span></div><div class="note" style="border-color:var(--ke)">Product = ethylene glycol (antifreeze). Purple → brown confirms unsaturation.</div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 3 · HYDROGENATION (Catalytic)</div><div class="eq"><span class="r">CH₂=CH₂ + H₂</span><div class="ab"><span class="ct">Ni, 200°C</span><span class="arr">⟶</span></div><span class="prod">CH₃–CH₃</span></div><div class="wd">Used industrially to harden vegetable oils into margarine (solid fat).</div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 4 · HX ADDITION — Markovnikov\'s Rule</div><div class="rn">Propene + HBr → products</div><div class="eq"><span class="r">CH₃–CH=CH₂ + HBr</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">products</span></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:.6rem;margin-top:.55rem"><div style="background:rgba(56,189,248,.1);border:1.5px solid #38bdf8;border-radius:9px;padding:.65rem;text-align:center"><div style="font-family:\'Fredoka One\',cursive;font-size:1.4rem;color:#38bdf8">90%</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.72rem;color:#fde68a">CH₃–CHBr–CH₃</div><div style="font-size:.68rem;color:#6b7280">Major — Markovnikov</div></div><div style="background:rgba(251,146,60,.1);border:1.5px solid #fb923c;border-radius:9px;padding:.65rem;text-align:center"><div style="font-family:\'Fredoka One\',cursive;font-size:1.4rem;color:#fb923c">10%</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.72rem;color:#fde68a">CH₃CH₂CH₂Br</div><div style="font-size:.68rem;color:#6b7280">Minor — Anti-Markov</div></div></div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 5 · HYDRATION (Steam Addition)</div><div class="eq"><span class="r">CH₂=CH₂ + H₂O</span><div class="ab"><span class="ct">H₃PO₄, 300°C, 70 atm</span><span class="arr">⟶</span></div><span class="prod">CH₃CH₂OH</span></div><div class="wd">Industrial method to produce ethanol from petroleum. Follows Markovnikov\'s rule.</div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 6 · HOBr ADDITION</div><div class="eq"><span class="r">CH₂=CH₂ + HOBr</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">BrCH₂–CH₂OH (bromohydrin)</span></div><div class="wd">OH adds to more substituted C (Markovnikov); Br adds to less substituted C.</div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 7 · POLYMERISATION (Addition)</div><div style="display:flex;flex-direction:column;gap:.38rem;margin:.4rem 0"><div style="font-family:\'JetBrains Mono\',monospace;font-size:.77rem;background:rgba(0,0,0,.23);padding:.45rem .8rem;border-radius:7px;color:#6ee7b7">n CH₂=CH₂ → (–CH₂–CH₂–)ₙ <span style="color:#fde68a">Polythene (PE)</span></div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.77rem;background:rgba(0,0,0,.23);padding:.45rem .8rem;border-radius:7px;color:#6ee7b7">n CH₂=CHCl → (–CH₂–CHCl–)ₙ <span style="color:#fde68a">PVC</span></div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.77rem;background:rgba(0,0,0,.23);padding:.45rem .8rem;border-radius:7px;color:#6ee7b7">n CH₂=CHCH₃ → (–CH₂–CH(CH₃)–)ₙ <span style="color:#fde68a">Polypropene (PP)</span></div></div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 8 · OZONOLYSIS</div><div class="eq"><span class="r">CH₃–CH=CH–CH₃ + O₃</span><div class="ab"><span class="ct">CCl₄, then Zn/H₂O</span><span class="arr">⟶</span></div><span class="prod">2CH₃CHO</span></div><div class="note" style="border-color:var(--ke)">O₃ cleaves C=C → aldehydes/ketones. Zn prevents over-oxidation. Used to determine alkene structure.</div></div>\n<div class="rb" style="border:1.5px solid rgba(0,229,160,.22);background:rgba(0,229,160,.04)"><div class="rl" style="color:var(--ke)">REACTION 9 · COMBUSTION</div><div class="eq"><span class="r">CH₂=CH₂ + 3O₂</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">2CO₂ + 2H₂O</span></div><div class="wd">Burns slightly smokier than alkanes (higher C:H ratio).</div></div>\n</div>');
    append('ky', '\n<div style="margin-top:1.5rem;border-top:2px dashed rgba(192,132,252,.35);padding-top:1.4rem">\n<div style="font-family:\'Fredoka One\',cursive;font-size:1.15rem;color:var(--ky);margin-bottom:.9rem">🧪 Chemical Properties &amp; Reactions</div>\n<div style="display:flex;gap:.7rem;flex-wrap:wrap;margin-bottom:1rem">\n  <div style="flex:1;min-width:220px;background:rgba(74,222,128,.07);border:1.5px solid rgba(74,222,128,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#4ade80;font-size:.88rem;margin-bottom:.35rem">🧪 Bromine Water — ✅ POSITIVE (needs 2 mol Br₂!)</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.73rem;margin-bottom:.28rem"><span style="background:#d4a017;color:#fff;padding:1px 6px;border-radius:4px">Br₂(aq)</span> <span style="color:#e2e8f0">→</span> <span style="background:#f5f5f5;color:#555;padding:1px 6px;border-radius:4px">Colourless</span></div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#7dd3fc">Step 1: R–C≡C–R + Br₂ → R–CBr=CBr–R</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#7dd3fc">Step 2: + Br₂ → R–CBr₂–CBr₂–R (tetrabromo)</div>\n    <div style="font-size:.73rem;color:#94a3b8;margin-top:.25rem">Triple bond has 2 π bonds → needs 2 mol Br₂.</div>\n  </div>\n  <div style="flex:1;min-width:200px;background:rgba(74,222,128,.07);border:1.5px solid rgba(74,222,128,.28);border-radius:11px;padding:.8rem 1rem">\n    <div style="font-family:\'Fredoka One\',cursive;color:#4ade80;font-size:.88rem;margin-bottom:.35rem">🧪 Baeyer\'s KMnO₄ — ✅ POSITIVE</div>\n    <div style="font-family:\'JetBrains Mono\',monospace;font-size:.73rem;margin-bottom:.28rem"><span style="background:#7b1fa2;color:#fff;padding:1px 6px;border-radius:4px">KMnO₄ purple</span> <span style="color:#e2e8f0">→</span> <span style="background:#795548;color:#fff;padding:1px 6px;border-radius:4px">Brown MnO₂</span></div>\n    <div style="font-size:.73rem;color:#94a3b8;margin-top:.25rem">Triple bond oxidised; purple disappears → brown ppt.</div>\n  </div>\n</div>\n<div style="background:linear-gradient(135deg,rgba(255,248,225,.05),rgba(255,224,178,.05));border:2px dashed #ff8f00;border-radius:11px;padding:.95rem 1.1rem;margin-bottom:.9rem">\n  <div style="font-family:\'Fredoka One\',cursive;color:#ff8f00;font-size:.95rem;margin-bottom:.6rem">⚗️ Acidic C–H Bond — Terminal Alkyne-1 ONLY (R–C≡C–H)</div>\n  <div style="font-size:.8rem;color:#94a3b8;margin-bottom:.65rem">The H on C1 of alkyne-1 is acidic (sp hybrid = high s-character). Gives 3 unique tests:</div>\n  <div style="display:flex;flex-direction:column;gap:.42rem">\n    <div style="background:rgba(0,0,0,.2);border-left:3px solid #fbbf24;border-radius:0 8px 8px 0;padding:.5rem .85rem"><div style="font-family:\'Fredoka One\',cursive;color:#fbbf24;font-size:.83rem">🫧 Na Metal Test → H₂ gas bubbles</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#7dd3fc;margin-top:.2rem">2R–C≡C–H + 2Na → 2R–C≡C–Na + H₂↑</div></div>\n    <div style="background:rgba(0,0,0,.2);border-left:3px solid #e2e8f0;border-radius:0 8px 8px 0;padding:.5rem .85rem"><div style="font-family:\'Fredoka One\',cursive;color:#e2e8f0;font-size:.83rem">⬜ Ammonical AgNO₃ → white precipitate</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#7dd3fc;margin-top:.2rem">R–C≡C–H + [Ag(NH₃)₂]⁺ → R–C≡C–Ag↓</div></div>\n    <div style="background:rgba(0,0,0,.2);border-left:3px solid #f87171;border-radius:0 8px 8px 0;padding:.5rem .85rem"><div style="font-family:\'Fredoka One\',cursive;color:#f87171;font-size:.83rem">🔴 Ammonical Cu₂Cl₂ → brick-red precipitate</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#7dd3fc;margin-top:.2rem">R–C≡C–H + Cu(NH₃)₂Cl → R–C≡C–Cu↓</div></div>\n  </div>\n  <div style="font-size:.73rem;color:#ff8f00;margin-top:.55rem">⚠️ Alkyne-2 (R–C≡C–R) has NO acidic H → gives NONE of these 3 tests!</div>\n</div>\n<div class="rb" style="border:1.5px solid rgba(192,132,252,.22);background:rgba(192,132,252,.04)"><div class="rl" style="color:var(--ky)">REACTION 1 · HYDROGENATION — Lindlar vs Ni</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:.6rem;margin:.45rem 0"><div style="background:rgba(74,222,128,.08);border:1.5px solid #4ade80;border-radius:9px;padding:.7rem"><div style="font-family:\'Fredoka One\',cursive;color:#4ade80;font-size:.8rem;margin-bottom:.25rem">Lindlar — STOPS at alkene!</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#fde68a">HC≡CH + H₂ → cis-CH₂=CH₂</div><div style="font-size:.7rem;color:#6b7280;margin-top:.2rem">Pd/BaSO₄; 25°C. Gives cis alkene only.</div></div><div style="background:rgba(56,189,248,.08);border:1.5px solid #38bdf8;border-radius:9px;padding:.7rem"><div style="font-family:\'Fredoka One\',cursive;color:#38bdf8;font-size:.8rem;margin-bottom:.25rem">Ni / Pt — Full hydrogenation</div><div style="font-family:\'JetBrains Mono\',monospace;font-size:.7rem;color:#fde68a">HC≡CH + 2H₂ → CH₃–CH₃</div><div style="font-size:.7rem;color:#6b7280;margin-top:.2rem">Both π bonds reduced → alkane.</div></div></div></div>\n<div class="rb" style="border:1.5px solid rgba(192,132,252,.22);background:rgba(192,132,252,.04)"><div class="rl" style="color:var(--ky)">REACTION 2 · HX ADDITION → Geminal Dihalide</div><div class="eq"><span class="r">HC≡CH + HCl</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">CH₂=CHCl (vinyl chloride)</span></div><div class="eq"><span class="r">CH₂=CHCl + HCl</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">CH₃–CHCl₂ (geminal dihalide)</span></div><div class="note" style="border-color:var(--ky)">Both additions follow Markovnikov\'s rule. Both halogens on the SAME carbon in geminal dihalide.</div></div>\n<div class="rb" style="border:1.5px solid rgba(192,132,252,.22);background:rgba(192,132,252,.04)"><div class="rl" style="color:var(--ky)">REACTION 3 · HYDRATION — Wacker Process</div><div class="eq"><span class="r">HC≡CH + H₂O</span><div class="ab"><span class="ct">HgSO₄, H₂SO₄, 80°C</span><span class="arr">⟶</span></div><span class="prod">CH₃CHO (ethanal)</span></div><div class="eq"><span class="r">RC≡CH + H₂O</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">R–CO–CH₃ (methyl ketone)</span></div><div class="wd">Ethyne → aldehyde (Markovnikov). Higher alkynes → ketones via enol intermediate.</div></div>\n<div class="rb" style="border:1.5px solid rgba(192,132,252,.22);background:rgba(192,132,252,.04)"><div class="rl" style="color:var(--ky)">REACTION 4 · TRIMERISATION → Benzene</div><div class="eq"><span class="r">3 HC≡CH</span><div class="ab"><span class="ct">Fe, 600°C</span><span class="arr">⟶</span></div><span class="prod" style="color:#818cf8">C₆H₆ (Benzene)</span></div><div class="note" style="border-color:var(--ky)">Benzene is a polymer of ethyne! Three ethyne molecules cyclise at 600°C in an iron tube.</div></div>\n<div class="rb" style="border:1.5px solid rgba(192,132,252,.22);background:rgba(192,132,252,.04)"><div class="rl" style="color:var(--ky)">REACTION 5 · COMBUSTION</div><div class="eq"><span class="r">2HC≡CH + 5O₂</span><div class="ab"><span class="arr">⟶</span></div><span class="prod">4CO₂ + 2H₂O</span></div><div class="note" style="border-color:var(--ky)">Burns with very bright hot flame (~3500°C). Oxy-acetylene torch used in metal welding &amp; cutting.</div></div>\n</div>');
  }

  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', run);
  } else {
    // Give the IIFE a tiny moment to render
    setTimeout(run, 0);
  }
})();
